...
- **公众号(沉默王二)**
    ...
    技术文通俗易懂，吹水文风趣幽默，专注于 Java 后端技术和程序人生分享，目前已有 8 万+ 读者关注，快来微信搜索「**沉默王二**」关注吧，回复关键字「**04**」还可以获取[一份 GitHub 星标 100k+的面试攻略](https://mp.weixin.qq.com/s/s0_XzGjHcgk2RwbCRzmgHg)。
