...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/images/fanshe/fanshe-01.png)

MethodAccessor 接口有三个实现类，其中的 MethodAccessorImpl 是一个抽象类，另外两个具体的实现类继承了这个抽象类。

![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/images/fanshe/fanshe-02.png)
...
![](http://cdn.tobebetterjavaer.com/tobebetterjavaer/images/images/fanshe/fanshe-04.png)
