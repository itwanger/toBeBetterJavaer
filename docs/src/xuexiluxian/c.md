...
![C语言入门教程](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-1.png)

直接长按识别/扫描下方二维码，关注后回复 「**08**」 下载这份 PDF 吧：

![扫码关注后回复「08」关键字](https://cdn.paicoding.com/tobebetterjavaer/images/gongzhonghao.png)
...
![翁恺教授的C语言视频课](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-2.png)

>视频地址：[https://www.icourse163.org/course/ZJU-199001](https://www.icourse163.org/course/ZJU-199001)

看完这套视频，大家至少能学到：

![程序设计入门-C 语言](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-3.jpg)
...
![C语言之父](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-1.jpg)

Dennis Ritchie是这样评价自己的亲儿子的：“**古怪的、有缺陷的，但同时也是一个巨大的成功**。”这句评语还是非常中肯的。

**第一，C语言在计算机领域起到了承上启下的作用**。

![C 语言的作用](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-4.jpg)
...
![MATLAB+C语言来控制机械臂](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-2.jpg)
...
![C 语言知识点](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-5.png)
...
![C 语言实现的计算器](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-6.jpg)
...
![C 语言实现编程语言](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-7.png)
...
![build your own lisp](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-8.png)
...
![啊哈 C语言](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-9.png)


给高中生、大一新生看的入门书《c primer plus》，语法全覆盖，细节多，知识点讲的清楚，缺点是琐碎，细节弯弯绕。


![c primer plus](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-10.png)


还有一本《C 程序设计语言》，这本书的作者是 C语言之父，所以全书讲的都是 C语言的核心。代码示例大多都是库函数的实现方法，内容简洁明了，干净利落，没有废话。

![C 程序设计语言](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-11.png)
...
![《C 陷阱与缺陷》、《C 专家编程》、《C 和指针》](https://cdn.paicoding.com/tobebetterjavaer/images/xuexiluxian/c-12.png)

尽管我不推荐大家看书入门，但我知道很多读者还是喜欢通过看书的方式学习。直接长按扫描下方二维码，关注后回复 「**C**」 下载这 PDF 版吧：

![（长按扫码识别）](https://cdn.paicoding.com/tobebetterjavaer/images/gongzhonghao.png)
