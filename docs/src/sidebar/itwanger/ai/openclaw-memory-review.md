---
title: 面试官：“OpenClaw的Memory和RAG有什么区别？”我轻描淡写：“一个用SQLite，一个用ElasticSearch。”面试官：“明天二面。”
shortTitle: OpenClaw Memory解析
description: 从面试视角拆解 OpenClaw Memory 和 RAG 的区别，解释 Session、长期记忆、SQLite 索引、FTS5、BM25 和检索增强机制。
---
