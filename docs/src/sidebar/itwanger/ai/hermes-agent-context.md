...
![](https://files.mdnice.com/user/3903/47d7b44e-0c91-4ea5-92d3-d7b5b0815894.png)
...
![](https://files.mdnice.com/user/3903/b55c526f-b643-4260-b695-bfd80b11cad7.png)
...
![](https://files.mdnice.com/user/3903/73462781-13fb-425b-b123-35c05f428a81.png)
...
![](https://files.mdnice.com/user/3903/59d3d6e3-bf44-453f-87f2-eae1ef8ec451.png)

它会自动拉取最新代码，处理依赖更新。

![](https://files.mdnice.com/user/3903/80b28cfc-5f9d-4a3e-a016-9548f5fd2edb.jpg)
...
![](https://files.mdnice.com/user/3903/2ce3a9ba-2ef3-47c5-9d8b-9a6f39db4b49.png)

安装脚本会自动检测你的操作系统，把 Python 3.11、Node.js、Git 这些依赖全部搞定。

![](https://files.mdnice.com/user/3903/c1e29f1e-7a5c-400e-84a0-c198fa2c532f.png)

装好之后跑一下 `hermes step` 进入配置向导。

![](https://files.mdnice.com/user/3903/5bf33f5d-0698-488b-a425-ad17b9483e6d.png)

如果之前装过 OpenClaw，配置可以直接迁移，省不少事。

![](https://files.mdnice.com/user/3903/2345dd3e-8dcd-49e0-90da-ca88ad0e278a.jpg)

看到这个界面就说明配置没问题了。

![](https://files.mdnice.com/user/3903/a03d6863-c57a-464d-9565-0547e91e8203.jpg)

## 05、给 Hermes Agent 配置 GLM-5.1

Hermes 的配置文件在 `~/.hermes/` 目录下。

![](https://files.mdnice.com/user/3903/18a664e0-9dbd-48e0-8945-0d7646577645.png)
...
![](https://files.mdnice.com/user/3903/83b47b3d-d281-4327-9f3e-b78407472e71.png)

模型配置这里，我用的是 GLM，在配置文件里改好 API Key 就行。

![](https://files.mdnice.com/user/3903/69fadf04-1302-4426-8396-0a4710cce1d0.png)

但这里有个坑我上次就踩过：API Key 过期的话 Hermes 报错信息不够明确。

![](https://files.mdnice.com/user/3903/f9d7055a-a9fe-4f76-b10f-94c92ebadf8e.jpg)

当时折腾了好一会儿，最后把问题丢给了 Codex 才搞定的。

![](https://files.mdnice.com/user/3903/f3510dab-58a6-4aae-8004-7c392b08a74d.png)

重新执行 `hermes` 进入主界面，随便发条消息测试一下，有回复就说明 OK。

![](https://files.mdnice.com/user/3903/bc9749ac-ad2e-4184-a0bb-15ace62177c6.png)
...
![](https://files.mdnice.com/user/3903/c7b3a83c-08f5-475c-bafe-5f1b2b325a62.jpg)
...
![](https://files.mdnice.com/user/3903/40fbb85a-2d01-4e95-9f6e-d26c548a1a49.jpg)
...
![](https://files.mdnice.com/user/3903/1a13a698-1bc0-49c3-aa7b-766f1e624c14.png)

去飞书开放平台创建应用，添加机器人能力。权限至少加上 `im:message` 和 `im:resource`。

![](https://files.mdnice.com/user/3903/96caf7c1-07fb-4b92-a3e6-80b396ff66f6.jpg)
...
![](https://files.mdnice.com/user/3903/86aba8a8-5fa1-470e-b455-3670873b4218.png)

在飞书控制台验证连接状态。

![](https://files.mdnice.com/user/3903/6b23ca2c-ee82-4b00-9bbd-865231f26152.png)

事件订阅里开通 `im.message.receive_v1`，回调配置开通 `card.action.trigger`。

![](https://files.mdnice.com/user/3903/4c5f877b-cabf-41e3-8519-c5ca331e7bf4.png)
...
![](https://files.mdnice.com/user/3903/789e4a6e-0981-4af0-a0d2-f179a8a08628.png)

开通之后就正常了。

![](https://files.mdnice.com/user/3903/01a6ffa2-8c28-42a1-afc9-45065ecfd5f2.png)
...
![](https://files.mdnice.com/user/3903/6ad0409f-e4f1-4a58-8a51-fbace7f96715.png)
...
![](https://files.mdnice.com/user/3903/0c238b4c-61f2-4edb-8142-17489b44d8f2.jpg)

这次确实没再出现上下文压缩的问题。

但新的问题来了，一直在 `terminal: "TARGET="B5` 不知道到底在干嘛。

![](https://files.mdnice.com/user/3903/c969982e-a05f-4f57-8634-4c48564c9181.jpg)
...
![](https://files.mdnice.com/user/3903/622d001d-296f-4783-91d2-d4679e5e784e.jpg)
