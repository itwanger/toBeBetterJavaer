---
title: 腾讯出手了！这次薪酬上不封顶。
shortTitle: 腾讯青云计划
description: 腾讯2026青云计划AI实习生招聘深度解读，首次开放AI/大模型方向实习岗，六大技术领域，薪酬上不封顶
tag:
  - 求职
category:
  - 求职
...
迫不及待给大家汇报一件让我非常兴奋的事，腾讯正式启动了**全年青云实习生招聘计划**，面向 AI/大模型方向。
...
就在发文前，腾讯 Hy3 preview 发布，这是雨哥（姚顺雨）加盟腾讯后的第一个重要成果，在聊天、代码、智能体、数理推理、指令遵循、上下文理解等方面的能力有了重大突破。

![](https://cdn.paicoding.com/stutymore/tencent-qingyun-ai-5777e8c76aa83fe1d8a50d2e5b36f0a2.png)

腾讯云、ima、WorkBuddy、QQ、QQ 浏览器、腾讯文档、腾讯乐享都已经可以使用 Hy3 preview 了。

我在面渣逆袭的 ima 知识库体验了一把，速度非常快，准确度拉满。

![](https://cdn.paicoding.com/stutymore/tencent-qingyun-ai-20260423192836.png)
...
因为你能真正参与到一个正在高速成长的项目中去，跟着产品一起成长。

况且鹅厂的 AI 产品非常多样化。从底层的混元大模型，到企业级的 WorkBuddy（AI 办公），再到腾讯云的一整套 AI 基础设施。

![](https://cdn.paicoding.com/stutymore/tencent-qingyun-ai-20260419123623.png)

你能想到的，鹅厂都在做。真正的海阔凭鱼跃，天高任鸟飞。

## 02、在鹅厂你能快速成长

为了获得一手情报，我特意跟几位已经在鹅厂的读者聊了聊。

聊的过程中，能感受到他们在鹅厂工作的幸福指数非常高。
...
> 混元像一个大型实验室——比校园有更明确的目标、更好的资源支持和更广泛的技术积累，大家都在做自己喜欢的方向和擅长的事。
...
> 把不可能变成突破，这种感觉我无法用语言来形容……这一切，都源于强大的算力支持和自由的探索空间。我们可以用于训练的算力很充足，并且，即使这个设想未必能落地，公司依然愿意全力投入算力、数据、人力，让你自由研究。
...
微信 14 亿用户，你写的代码是真的要上线给上亿人用的，不是在实验室里跑个 benchmark 交个作业就完事了。

而且大场景带来的不只是成就感。技术深度也跟着上来了。要让一个 Agent 服务上亿用户，稳定性、延迟、成本，每一个维度都是挑战。这种挑战会逼着人快速成长。
...
能跟这个级别的导师在一个团队里干活，未来可以说是无限可能。

而且我了解到，鹅厂的组织架构趋于扁平化。实习生有想法可以直接跟技术负责人说，不用层层汇报。
...
青云计划覆盖六大技术方向：大语言模型、NLP（自然语言处理）、多模态、智能体（Agent）、搜索推荐、AI 基础设施。

不管你是搞模型训练的，还是做 Agent 应用落地的，还是搞底层 infra 的，都有岗位。
...
![](https://cdn.paicoding.com/stutymore/tencent-qingyun-ai-20260419124422.png)
...
- **理解系统的复杂性**——知道一个 Agent 系统里有哪些模块，每个模块在什么时机做什么事儿，模块之间怎么通信、怎么传递状态。
- **抽象和结构化思维**——能从一堆乱七八糟的需求里，抽出最核心的循环、最本质的工具边界、最关键的上下文结构。
- **驾驭不确定性**——能在一个概率性的系统里，设计出确定性的兜底逻辑。这是最难的，因为传统软件工程训练的是「一切都要可预测」，而 Agent 系统本质上是「大部分时候可预测、少部分时候彻底失控」。

## 06、为什么有鹅选鹅

聊聊我自己的看法。

第一，平台决定了你能接触到什么级别的数据、什么规模的算力、什么水平的同事。

就比如说前文提到的 Hy3 preview， 2026 年 1 月底开始训练，今天就发布了，短短不到三个月，就有这样瞩目的成绩，离不开鹅厂足够的算力和人力啊。

只能说，腾讯这个数量级的互联网大厂，实力能与之匹敌的真的屈指可数。

第二，整个公司的文化是技术导向的，在这样的环境里，我们可以有时间有精力去做自己喜欢的事情。
