...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-01.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-02.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-03.png)

如果使用的是 Intellij IDEA 旗舰版，可以直接通过 Intellij IDEA 新建 Spring Boot 项目。


![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-2d03d0a4-0e87-4cd3-974d-f35bc440bdf0.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-04.png)


可以使用 `tree  -CfL 3` 命令以树状图列出目录的内容：

![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-05.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-06.png)


经过 2.5s 左右的 build 后，项目启动成功了，可以在日志中看到 Web 项目是以 Tomcat 为容器的，默认端口号为 8080，根路径为空。

![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-07.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-08.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-09.png)


利用终端工具 [Tabby](https://mp.weixin.qq.com/s/HeUAPe4LqqjfzIeWDe8KIg)，将 jar 包上传到服务器。

![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-10.png)


执行 `java -jar tobebetterjavaer-0.0.1-SNAPSHOT.jar` 命令。

![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-11.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-12.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-13.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/springboot/initializr-14.png)
