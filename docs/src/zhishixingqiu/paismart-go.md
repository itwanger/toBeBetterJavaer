---
title: 派聪明 Go 版 RAG 知识库项目：Go 语言企业级 AI 实战教程
shortTitle: Go版RAG知识库派聪明
description: 派聪明 Go 版是企业级 RAG 知识库项目的 Go 语言重构版，覆盖 Gin、GORM、Tika Server、gojieba、Redis、MinIO、Kafka、Elasticsearch、WebSocket 和大模型接入。
keywords:
  - 派聪明Go
  - 派聪明RAG
  - Go RAG项目
...
head:
  - - meta
    - name: keywords
      content: 派聪明Go, 派聪明RAG, Go RAG项目, PaiSmart Go, Gin, GORM, Tika Server, gojieba, Elasticsearch, AI知识库, 企业级RAG
---
...
![球友们发自内心对星球的认可](https://cdn.tobebetterjavaer.com/paicoding/c460dcb29244ec470106763f48c1d087.png)
...
看到这就想迫不及待地解锁派聪明源码和教程的同学，请扫下面的优惠券（或者长按自动识别）加入我们吧，[星球](https://javabetter.cn/zhishixingqiu/)目前定价 169 元/年（后续会涨价至 179 元），优惠完只需要 139 元，每天不到 0.38 元，绝对的超值。
...
> 派聪明源码申请方式：[https://t.zsxq.com/XBc0a](https://t.zsxq.com/XBc0a)
...
![](https://cdn.tobebetterjavaer.com/paicoding/d2c867d82d57ef1560fed6267eb02590.png)

加入[「二哥的编程星球」](https://javabetter.cn/zhishixingqiu/)后，你还可以享受以下专属内容服务：

- 1、**付费文档:** [PaiFlow工作流Agent](https://javabetter.cn/zhishixingqiu/paiflow.html)、[派聪明 RAG Java 版](https://javabetter.cn/zhishixingqiu/paismart.html)、[微服务 PmHub](https://javabetter.cn/zhishixingqiu/pmhub.html)、[前后端分离技术派](https://javabetter.cn/zhishixingqiu/paicoding.html)、轮子 MYDB、入门编程喵、Agent+MCP 的校招派、简历派、类 dify 的工作流PaiAgent 等项目配套的 60 万+ 字教程查看权限
...
讲真心话，这个价格也不会持续很久，星球已经 11700+ 人了，马上会迎来一波新的涨价（179 元），所以早买早享受，不要等，想好了就去冲，错过不能说后悔一辈子，但至少会有遗憾。
