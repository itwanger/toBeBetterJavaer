...
![面渣逆袭+派聪明 拿下招银网络+科大讯飞](https://cdn.paicoding.com/paicoding/fb5db62ab92092e2d74a4916b6a45710.png)


![派聪明拿到的日常实习](https://cdn.paicoding.com/paicoding/da01a535b091c5ebeed70bf9a08a90c6.png)


![派聪明拿下合合信息](https://cdn.paicoding.com/paicoding/3518a76f439c325de8df763482cbebc4.png)


![派聪明拿下小红书](https://cdn.paicoding.com/paicoding/7bed4d34460749d68db9c0fcbc4621a8.png)


![派聪明拿下网易](https://cdn.paicoding.com/paicoding/5f227edcb38ffe41aea8fc0880f64cad.png)
...
![派聪明优惠券](https://cdn.paicoding.com/paicoding/97601d7a337d7d944b02bb4a79cd6430.png)
...
![派聪明的聊天助手：会依据知识库进行问答](https://cdn.paicoding.com/paicoding/2550c873a349d8bee29d46400f12ce76.png)
...
![凭借技术派拿到小红书实习](https://cdn.paicoding.com/paicoding/4e881a6ffb241b18fc0a1c34c14851ca.png)

技术派这个项目如果你能认真学完，会收获非常非常多，基本上一个企业级的 Web 开发项目用到的技术栈，技术派都覆盖到了。

![技术派的派聪明模块](https://cdn.paicoding.com/paicoding/f661e0f448fd20532840b062f1019662.png)

那为了延续正宗的皇家血脉，我把**派聪明**这三个字延续到了新的 RAG 项目，也就是大家目前看到的这个派聪明 AI 知识库项目（界面还是非常清爽的 😄）。

![派聪明的聊天助手](https://cdn.paicoding.com/paicoding/7e4d40bd09296ac248a1ff7d7296e51d.png)
...
![派聪明的系统概述](https://cdn.paicoding.com/stutymore/README-20250730102655.png)
...
![派聪明 RAG 知识库](https://cdn.paicoding.com/paicoding/b693e6e8cdc26e06a3f6665adb77142e.png)
...
![Apache Tika解析文档](https://cdn.paicoding.com/paicoding/0a87cde001de6edb76fae642011a6c01.png)
...
![ES进行混合检索](https://cdn.paicoding.com/paicoding/7bd580712564d9951c1379607fe8e4c5.png)
...
![球友也一直在存 RAG](https://cdn.paicoding.com/paicoding/9cef18d25edcaf16ee8d71e75a614e26.png)
...
![置顶帖球友必看](https://cdn.paicoding.com/paicoding/047197ef09311d1be141530cbb5ab502.png)
...
![派聪明的架构概览](https://cdn.paicoding.com/stutymore/README-20250730101618.png)
...
![ANN找出语义接近的向量](https://cdn.paicoding.com/paicoding/27295a1412addf313a9be871381a385b.png)
...
![RAG 减少幻觉](https://cdn.paicoding.com/paicoding/aeb6326dd7be502629f9909fb4b0b049.png)
...
![RAG的查询](https://cdn.paicoding.com/paicoding/57a300255f7cb9bd1ff093a3fb85eb1b.png)
...
![向量数据库](https://cdn.paicoding.com/paicoding/8d53a234c2e8cf4be0d8189d49950ce2.png)

那基于向量知识库的语义检索，虽然解决了传统关键词匹配的局限性，但显然关键词搜索这种场景还是需要的，所以派聪明兼具了关键词检索和语义检索两种能力。

![CSDN@智兔唯新](https://cdn.paicoding.com/paicoding/ab8396ec99cdd47ffb948325ee43e666.png)
...
![Spring Boot 3.4.2+JDK17](https://cdn.paicoding.com/paicoding/249d872fe674df0c1918f34ea5e407f2.png)
...
![Kafka八股](https://cdn.paicoding.com/paicoding/82c03ebd7419d4e37f2314e6ec454be5.png)

MinIO 的话，在处理文件的时候也经常用到，[编程喵当时有讲到](https://www.yuque.com/itwanger/vn4p17/ta5vr1)，但技术派和 PmHub 中都没有应用，这次派聪明我们也一并补齐了。

![MinIO的应用](https://cdn.paicoding.com/paicoding/689747578161e984eee744f396f51094.png)

### 03、ElasticSearch

集成 Elasticsearch，实现「关键词+语义」的双引擎搜索。目前已经通过 ES 的 bool should 查询实现了关键词+语义的搜索方式。

![Elasticsearch面试题](https://cdn.paicoding.com/paicoding/cae14303e0159ad99e8fb4f828e5b01e.png)

### 04、Vue 3+TypeScript+Vite

派聪明全面采用了 Vue 3 的 Composition API，技术派当时用的是 React，等于说前端的三驾马车就只剩下了 Angular。

![派聪明用了 Vue](https://cdn.paicoding.com/paicoding/019d7cdded144f2169256e473ce0431d.png)
...
![派聪明用到的Pinia](https://cdn.paicoding.com/paicoding/730208c77236a504b8b807ddc5c104a2.png)
...
![派聪明前端采用Monorepo架构](https://cdn.paicoding.com/paicoding/5457a9a50ebcb68a7f81c40a396ac305.png)
...
![JWT+Spring Security](https://cdn.paicoding.com/paicoding/bebeb4d8d20c4cc0fcbe88a7fa813180.png)
...
![RBAC](https://cdn.paicoding.com/paicoding/cda9a817ecda87a5a609986fd9008401.png)
...
![Mockito+TDD](https://cdn.paicoding.com/paicoding/e2adadd787040c8dcbab4750ec75efe7.png)

## 八、解锁派聪明源码+教程

那这次为了避免盗版，这次的代码仓库采用的是邀请制，加入星球后，在星球第一个置顶帖【球友必看】中获取邀请链接，审核通过后即可查看。

![派聪明的源码申请](https://cdn.paicoding.com/paicoding/0abd7b441b744b33d48277be776e58cc.png)

派聪明的教程，这次托管在技术派教程上，之前只要在技术派上绑定过星球的成员编号，均可以解锁查看。

>派聪明教程地址：https://paicoding.com/column/10/1

![派聪明教程](https://cdn.paicoding.com/paicoding/a157a62358a6b3c2dab478988143271a.png)

并且了照顾大家的阅读习惯，我们也会在星球里第一时间同步。

![星球付费专栏](https://cdn.paicoding.com/paicoding/d2c867d82d57ef1560fed6267eb02590.png)
...
![美团快手 TP-LINK 拼多多](https://cdn.paicoding.com/stutymore/readme-20250703180225.png)

![阿里云荣耀字节](https://cdn.paicoding.com/stutymore/readme-20250703180738.png)
...
![派聪明整体设计方案](https://cdn.paicoding.com/paicoding/6b670c22740e9e7b3dfae35fd646196e.png)

![派聪明 prompt](https://cdn.paicoding.com/paicoding/1e5e0055300a70a4cb83791f889bec20.png)

![派聪明教程目录](https://cdn.paicoding.com/stutymore/readme-20250106103555.png)
...
![球友们加入星球后的真实反馈](https://cdn.paicoding.com/paicoding/0d2b52387576b0884e832c05594fc9de.png)

我们的代码，严格按照大厂的标准来，无论是整体的架构，还是具体的细节，都是无可挑剔的学习对象。

![派聪明的代码细节](https://cdn.paicoding.com/paicoding/e946bb63f1fe5279888bb7f1fcb649b0.png)

之前曾有球友问我：“二哥，你的星球怎么不定价 199、299、399 啊，我感觉星球提供的价值远超这个价格啊。”

答案很明确，我有自己的原则，**拒绝割韭菜，用心做内容，能帮一个是一个**。

![我愿意给大家最真诚的服务](https://cdn.paicoding.com/paicoding/e946bb63f1fe5279888bb7f1fcb649b0.png)
