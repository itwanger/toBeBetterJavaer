---
title: 派聪明 RAG 知识库项目：企业级 AI 知识库实战教程
shortTitle: 派聪明RAG知识库
description: 派聪明是一个企业级 RAG 知识库项目，覆盖文档解析、向量化、混合检索、权限过滤、流式问答、MinIO、Elasticsearch、Redis、Kafka 和大模型接入。
keywords:
  - 派聪明RAG
  - 派聪明RAG知识库
  - PaiSmart
...
head:
  - - meta
    - name: keywords
      content: 派聪明RAG, 派聪明RAG知识库, PaiSmart, RAG知识库, AI知识库项目, Java RAG项目, 企业级AI项目, Elasticsearch混合检索, 大模型应用开发
---
