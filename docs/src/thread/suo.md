...
![](https://cdn.paicoding.com/tobebetterjavaer/images/nice-article/other-bukfsdjavassmtjstd-3d0981fb-8f3c-4d66-90c4-170178f2ff76.png)
...
![](https://cdn.paicoding.com/tobebetterjavaer/images/nice-article/other-bukfsdjavassmtjstd-dc687c10-f5c2-483f-8446-16e24c89ec51.png)

如上图所示，假设有一口水井，有管理员看守，管理员有一把锁，只有拿到锁的人才能够打水，打完水要把锁还给管理员。每个过来打水的人都要管理员的允许并拿到锁之后才能去打水，如果前面有人正在打水，那么这个想要打水的人就必须排队。管理员会查看下一个要去打水的人是不是队伍里排最前面的人，如果是的话，才会给你锁让你去打水；如果你不是排第一的人，就必须去队尾排队，这就是公平锁。

但是对于非公平锁，管理员对打水的人没有要求。即使等待队伍里有排队等待的人，但如果在上一个人刚打完水把锁还给管理员而且管理员还没有允许等待队伍里下一个人去打水时，刚好来了一个插队的人，这个插队的人是可以直接从管理员那里拿到锁去打水，不需要排队，原本排队等待的人只能继续等待。如下图所示：

![](https://cdn.paicoding.com/tobebetterjavaer/images/nice-article/other-bukfsdjavassmtjstd-f39276f9-26b7-4a57-bc7f-32a3f7221897.png)

接下来我们通过ReentrantLock的源码来讲解公平锁和非公平锁。

![](https://cdn.paicoding.com/tobebetterjavaer/images/nice-article/other-bukfsdjavassmtjstd-7b929419-86a4-4e72-99f4-228aa5597097.png)

根据代码可知，ReentrantLock里面有一个内部类Sync，Sync继承AQS（AbstractQueuedSynchronizer），添加锁和释放锁的大部分操作实际上都是在Sync中实现的。它有公平锁FairSync和非公平锁NonfairSync两个子类。ReentrantLock默认使用非公平锁，也可以通过构造器来显示的指定使用公平锁。

下面我们来看一下公平锁与非公平锁的加锁方法的源码:

![](https://cdn.paicoding.com/tobebetterjavaer/images/nice-article/other-bukfsdjavassmtjstd-758a4637-fd98-49f2-bb0f-9690c363e0b6.png)

通过上图中的源代码对比，我们可以明显的看出公平锁与非公平锁的lock()方法唯一的区别就在于公平锁在获取同步状态时多了一个限制条件：hasQueuedPredecessors()。

![](https://cdn.paicoding.com/tobebetterjavaer/images/nice-article/other-bukfsdjavassmtjstd-8278a6df-0d0c-4547-8b74-229b58fc893d.png)
