---
title: 5000字10张图讲清楚本地变量ThreadLocal
...
![ThreadLocal各引用间的关系](https://cdn.paicoding.com/tobebetterjavaer/images/thread/ThreadLocal-01.png)
...
![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822202300.png)
...
![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822202707.png)
...
![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822203134.png)
...
![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822203306.png)
...
![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822203619.png)
...
![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822211802.png)

在某些操作过程中（例如添加、获取等），可以增加额外的清理操作来扫描并移除“脏”Entry。这可以通过遍历哈希表，并删除那些键为null的条目来实现。源码中的cleanSomeSlots方法就是这样一个例子。

![](https://cdn.paicoding.com/stutymore/ThreadLocal-20230822212010.png)
