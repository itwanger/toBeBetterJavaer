...
作为一个普普通通的大学生，**我就是靠计算机专业改变的命运**！讲良心话，我身边有不少 985、211 毕业的大学生，他们现在的收入都没有我高——比如说我老婆，她就是郑大毕业的。

![](https://pic1.zhimg.com/50/v2-c504f8c9b5c75ede4886c7bbb1dcd4bc_720w.jpg?source=1940ef5c)

当然了，我不是一直比我老婆收入多，而是最近这两年，突然有了质的飞跃。

别问我干了什么，无非就是敲敲代码、代码敲完了就看看书（嗯，敲代码真的能挣钱，看书真的能学习）。看那些书呢？**当然是经典的计算机图书，比如说 CSAPP、Java 编程思想、现代操作系统、程序是如何跑起来的等等**。

学计算机千万不要心急，一定要循序渐进，你可以按照我这条线路（偏 Java 后端路线）学下去：入门→工具→框架→数据库→并发编程→底层→性能优化→设计模式→操作系统→计算机网络→数据结构与算法→面试→架构→管理→活着（重要）

![](https://picx.zhimg.com/50/v2-5cb71da2f9332fb3c89dc30c4091c7f7_720w.jpg?source=1940ef5c)

我花了一个月的时间把近十年来读过的书全部整理了一下，对学习计算机的同学（尤其是 Java 后端方向）会很有帮助：

[](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/ExjM-xdqMFFY1NIZffz-Ng)

接下来我来说说，计科，人工智能，软工，大数据，物联网，网络工程，到底该怎么选？
...
再比如说，我一开始也没有刷过 LeetCode 的，我那时候参加工作早，不刷 LeetCode 确实是可以找到工作的，但现在不同了。**数据结构与算法是学习编程的基础，所以大家应该看到了，我分享了不少于数据结构与算法相关的资料：**

[](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/0lhj-iCc88UEbpVnevfMXg)
...
**想成为优秀的计算机工程师，从大学开始，需要做哪些准备？**我想这应该是你最关心的问题了。
...
**可以先看看我整理的这份[GitHub 上星标 115k+ 的 Java 教程](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/d7Z0QoChNuP9bTwAGh2QCw)，里面涵盖了 Java 所有的知识点，包括 Java 语法、Java 集合框架、Java IO、Java 并发编程和 Java 虚拟机，内容不多，只讲重点**。

![](https://pic4.zhimg.com/50/v2-df926504ff56288600f84104b9843cda_720w.jpg?source=1940ef5c)

[](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/d7Z0QoChNuP9bTwAGh2QCw)
...
![](https://pic2.zhimg.com/50/v2-074013ff30d42d43e574e255139a6b9c_720w.jpg?source=1940ef5c)

[](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/wvzB1p9_Yu7n7Ak83DrrdA)

我整理的这份 LeetCode 刷题笔记，**对算法薄弱和需要提高算法的同学很有帮助**。说一下我的刷题心得：从易到难，一遍一遍地刷，尽量使用自己熟悉的编程语言，比如说 Java 程序员尽量用 Java 来解题，这样刷题的幸福感也会提升很大一截。
...
[](https://link.zhihu.com/?target=https%3A//gplt.patest.cn/rank/school)
...
我给你列出来了！大致按照列出的顺序，借助我所建议的教材或者视频课程（最好二者兼用），可以先花 100到200 个小时学习完其中一个科目，然后记着，你的整个职业生涯里，一定要不时地温习 。

![](https://pic3.zhimg.com/50/v2-aa29a9cf745a1391cdef335d2ccc8ad2_720w.jpg?source=1940ef5c)

**怎么找到这些书籍或者视频课程，可以在下面这个开源的 GitHub 仓库里找到哦，记得 star 呀！**

[](https://link.zhihu.com/?target=https%3A//github.com/itwanger/LearnCS-ByYourself)

计算机专业可能是一个最不会说谎的专业，你选对了，你付出了，还是能从“卷”中走出来了的。高考改变命运，但你的人生本不应该只被一次成绩决定。

**我是** [@沉默王二](https://www.zhihu.com/people/075d75d40d302f09ae51415c32837a84) **，码字不易，希望你们能够喜欢，如果能够对你起到一点点帮助，那就太好不过了！温馨提醒一点，记得让它躲进收藏夹吃灰哦，顺带点个赞就更好了，你最美你最帅！**

转载链接：[https://www.zhihu.com/question/468005193/answer/1967203613](https://www.zhihu.com/question/468005193/answer/1967203613)
