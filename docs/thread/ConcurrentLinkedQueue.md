...
![1.ConcurrentLinkedQueue初始化状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-feb483e5-84d5-4404-8382-a411d396790c.png)
...
![2.offer 1后队列的状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-cc6da026-8873-4a86-8305-3c32357af240.png)
...
![3.队列offer 2后的状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-b85e059e-debf-486c-812b-b080aef17653.png)


**tail指向的节点由Node0改变为Node2**,这里的casTail失败不需要重试的原因是，offer代码中主要是通过p的next节点q(`Node<E> q = p.next`)决定后面的逻辑走向的，当casTail失败时状态示意图如下：

![4.队列进行入队操作后casTail失败后的状态图.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-244b7423-3c23-47a8-adc0-5278198b26d5.png)
...
![5.线程A和线程B有可能的执行时序.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-a550e577-cd45-48dc-9ea1-f601dc56a6d0.png)
...
![6.队列初始状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-86155425-d08d-43ea-aaa9-db80fae3ce6f.png)
...
![7.队列出队操作后的状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-3446de94-6c1f-4082-b777-aad844b2ec2f.png)
...
![8.经过一次循环后的状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-612eebde-9853-4711-bff0-8cc954eb85c7.png)
...
![9.Node2从队列中出队后的状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-d1303ca8-312e-4a0b-bed9-049b30ef8f2d.png)
...
![10.offer和poll相互影响分析时队列初始状态.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-f2d086fd-e05e-4079-ac1a-2bb03af524cc.png)

因此在线程A执行offer时，线程B执行poll就会存在如下一种情况：

![11.线程A和线程B可能存在的执行时序.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-3bfdc392-029a-495c-9bc3-20fd2aebf7b6.png)
...
![12.线程B进行poll后队列的状态图.png](https://cdn.jsdelivr.net/gh/itwanger/toBeBetterJavaer/images/thread/ConcurrentLinkedQueue-dae77ba8-7d94-4477-9ff4-164cc9b66cb7.png)
