...
| 字段 | 示例 | 说明 |
|---|---|---|
| `API_KEY` | `21d267c1-b3f4-...` | 火山**新版**控制台 → 声音复刻 2.0 → API Key（单键鉴权，不再需要 App ID / Access Key） |
...
**语速**：B29 起默认 `speed_ratio: 1.10`（当前最佳）· B27 曾短期用 1.15 已弃用
...
API_KEY     = "21d267c1-b3f4-4cc5-b844-1a96c9f45c93"   # 二哥呀 · 新版控制台
...
```json
{
  "speed_ratio":  1.10,       // 语速 0.5~2.0，二哥呀风格用 1.10
  "volume_ratio": 1.0,
  "pitch_ratio":  1.0
}
```
