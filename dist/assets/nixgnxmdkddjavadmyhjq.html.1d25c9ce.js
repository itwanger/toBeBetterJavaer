import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as a,c as r,a as e,d as i,b as d,e as s,r as t}from"./app.53992e11.js";const c={},v={href:"https://mp.weixin.qq.com/s/3RVsFZ17F0JzoHCLKbQgGw",target:"_blank",rel:"noopener noreferrer"},u=e("strong",null,"560 多名",-1),o={href:"https://mp.weixin.qq.com/s/3RVsFZ17F0JzoHCLKbQgGw",target:"_blank",rel:"noopener noreferrer"},m=s(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>我之前写过两篇关于优化相关文章，发表之后，在全网受到广大网友的好评。阅读量和点赞率都很高，说明了这类文章的价值。</p><p>今天接着优化这个话题，我们一起聊聊Java中代码优化的30个小技巧，希望会对你有所帮助。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-52b1af62-86fe-4c7a-b716-e5e5968c733c.jpg" alt="" loading="lazy"></p><h2 id="_1-用string-format拼接字符串" tabindex="-1"><a class="header-anchor" href="#_1-用string-format拼接字符串" aria-hidden="true">#</a> 1.用String.format拼接字符串</h2><p>不知道你有没有拼接过字符串，特别是那种有多个参数，字符串比较长的情况。</p><p>比如现在有个需求：要用get请求调用第三方接口，url后需要拼接多个参数。</p><p>以前我们的请求地址是这样拼接的：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>String url = &quot;http://susan.sc.cn?userName=&quot;+userName+&quot;&amp;age=&quot;+age+&quot;&amp;address=&quot;+address+&quot;&amp;sex=&quot;+sex+&quot;&amp;roledId=&quot;+roleId;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果不做任何处理，当我们请求add接口时，执行结果直接报错：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-478149b7-8982-4b55-accd-2c78c6521dea.jpg" alt="" loading="lazy"></p><p>what？用户能直接看到错误信息？</p><p>这种交互方式给用户的体验非常差，为了解决这个问题，我们通常会在接口中捕获异常：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@GetMapping(&quot;/add&quot;)
public String add() {
    String result = &quot;成功&quot;;
    try {
        int a = 10 / 0;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回结果会是true吗？</p><p>答案：是false。</p><p>有些同学可能会反驳，Integer中不是有范围是：<code>-128-127</code>的缓存吗？</p><p>为什么是false？</p><p>先看看Integer的构造方法：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-8128d857-c699-4592-b8af-eec334a0fdcc.jpg" alt="" loading="lazy"></p><p>它其实并没有用到<code>缓存</code>。</p><p>那么缓存是在哪里用的？</p><p>答案在<code>valueOf</code>方法中：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-b332dd5f-e7c1-4c07-8a2b-c5651d4375b0.jpg" alt="" loading="lazy"></p><p>如果上面的判断改成这样：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>String orderStatus1 = new String(&quot;1&quot;);
