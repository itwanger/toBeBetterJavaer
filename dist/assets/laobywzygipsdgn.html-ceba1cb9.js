...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="idea-中做个测试" tabindex="-1"><a class="header-anchor" href="#idea-中做个测试" aria-hidden="true">#</a> IDEA 中做个测试</h2><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-laobywzygipsdgn-5d234914-d404-44cf-85bb-8e7fa8ae498b.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>ip 属地国内的话，会展示省份，国外的话，只会展示国家。可以通过如下图这个方法进行进一步封装，得到获取 IP 属地的信息。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-laobywzygipsdgn-a6e0fc04-60f1-4629-9a69-3186d644cda0.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>下面是官网给出的命令运行 jar 方式给出的测试 demo，可以理解下</p></blockquote><h2 id="编译测试程序" tabindex="-1"><a class="header-anchor" href="#编译测试程序" aria-hidden="true">#</a> 编译测试程序</h2><p>通过 maven 来编译测试程序。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># cd 到 java binding 的根目录
cd binding/java/
mvn compile package
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>可以通过分别设置 cache-policy 为 file/vectorIndex/content 来测试三种不同缓存实现的效果。@Note: 注意 bench 使用的 src 文件要是生成对应 xdb 文件相同的源文件。</p><blockquote><p>到这里获取用户 IP 属地已经完成啦，这篇文章介绍的 v2.0 版本，有兴趣的小伙伴可以登录上门的 github 地址了解下 v1.0 版本</p></blockquote>`,51);function g(h,x){const d=r("ExternalLinkIcon");return s(),l("div",null,[o,i("p",null,[e("地址："),i("a",v,[e("https://ip.taobao.com/"),t(d)]),e("。")]),u,i("p",null,[b,e("，github 地址："),i("a",p,[e("https://github.com/lionsoul2014/ip2region"),t(d)])]),m])}const I=a(c,[["render",g],["__file","laobywzygipsdgn.html.vue"]]);export{I as default};
