...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用" aria-hidden="true">#</a> 基本使用</h2><blockquote><p>下面我们来聊聊MyBatis的基本使用方法，涵盖了基本的增删改查操作。</p></blockquote><h3 id="表结构说明" tabindex="-1"><a class="header-anchor" href="#表结构说明" aria-hidden="true">#</a> 表结构说明</h3><p>这里将以mall项目中权限管理模块相关表为例进行介绍，具体表结构如下。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-mybatiszyytszhwskczjsj-e4c9fdba-fef0-43bf-9d1b-a58b1eae41e8.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="项目结构说明" tabindex="-1"><a class="header-anchor" href="#项目结构说明" aria-hidden="true">#</a> 项目结构说明</h3><p>本文示例使用了<code>mall-learning</code>项目中的<code>mall-tiny-mybatis</code>模块代码，具体项目结构如下。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-mybatiszyytszhwskczjsj-89145395-c273-4300-8ec3-1676c2a4a855.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="select" tabindex="-1"><a class="header-anchor" href="#select" aria-hidden="true">#</a> select</h3><ul><li>首先是查询操作，这里我们以后台用户表<code>ums_admin</code>为例，编写一个<code>根据ID查询用户</code>的方法，先创建实体类<code>UmsAdmin</code>；</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class UmsAdmin implements Serializable {
    private Long id;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>本文主要介绍了MyBatis中一些比较常规的用法，涵盖了SpringBoot集成、基本查询、动态SQL和高级查询，建议大家收藏起来，在对MyBatis的用法有所遗忘的时候拿出来看看。</p>`,107),b={href:"https://github.com/macrozheng/mall-learning/tree/master/mall-tiny-mybatis",target:"_blank",rel:"noopener noreferrer"},g=e("hr",null,null,-1),p=e("p",null,"没有什么使我停留——除了目的，纵然岸旁有玫瑰、有绿荫、有宁静的港湾，我是不系之舟。",-1),h={href:"https://mp.weixin.qq.com/s/gOuoM27tl4l6GW7aqZu98Q",target:"_blank",rel:"noopener noreferrer"},q={href:"https://mp.weixin.qq.com/s/3Iry19JaEoN4pA3-JDtVhw",target:"_blank",rel:"noopener noreferrer"},x={href:"https://mp.weixin.qq.com/s/CyJAVQza-9zmDdboStKe8w",target:"_blank",rel:"noopener noreferrer"},y={href:"https://mp.weixin.qq.com/s/4qHRBcJn1AvP07U4H6JcOQ",target:"_blank",rel:"noopener noreferrer"},f={href:"https://mp.weixin.qq.com/s/MGqyie9KvD6kH8Tuv2mqOw",target:"_blank",rel:"noopener noreferrer"},_={href:"https://mp.weixin.qq.com/s/Pu1cddsQOiMfCU4I96iygQ",target:"_blank",rel:"noopener noreferrer"},U={href:"https://mp.weixin.qq.com/s/9f_sOLiRwDS3pzC-mJ9jLQ",target:"_blank",rel:"noopener noreferrer"},R={href:"https://mp.weixin.qq.com/s/zYLEUmbfmiKeFk03e1TxbA",target:"_blank",rel:"noopener noreferrer"},B={href:"https://mp.weixin.qq.com/s/QYFB2NHhyZSBfdgSUcZU5g",target:"_blank",rel:"noopener noreferrer"},k={href:"https://mp.weixin.qq.com/s/SfEUk-4hE6ezUk2Lu6cd2g",target:"_blank",rel:"noopener noreferrer"},M=e("figure",null,[e("img",{src:"https://files.mdnice.com/user/3903/b7e50cf4-6fca-4511-9bfd-aa1ed9eb587b.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function w(L,S){const n=r("ExternalLinkIcon");return d(),a("div",null,[e("blockquote",null,[e("p",null,[e("a",u,[i("二哥的编程星球"),l(n)]),i("已经有 "),v,i(" 球友加入了，如果你也需要一个良好的学习氛围，"),e("a",m,[i("戳链接"),l(n)]),i("加入我们吧！这是一个Java学习指南+编程实战+LeetCode 刷题的私密圈子，你可以向二哥提问、帮你制定学习计划、和球友一起打卡成长，冲冲冲。")])]),o,e("blockquote",null,[e("p",null,[i("项目源码地址: "),e("a",b,[i("https://github.com/macrozheng/mall-learning/tree/master/mall-tiny-mybatis"),l(n)])])]),g,p,e("ul",null,[e("li",null,[e("a",h,[i("曝光秋招毁约公司"),l(n)])]),e("li",null,[e("a",q,[i("垃圾外包，离职也罢"),l(n)])]),e("li",null,[e("a",x,[i("非科班转码"),l(n)])]),e("li",null,[e("a",y,[i("推荐 10 个神级 Intellij IDEA 插件"),l(n)])]),e("li",null,[e("a",f,[i("美团率先开奖 24k，不甘心？"),l(n)])]),e("li",null,[e("a",_,[i("Fleet，Java 轻量级 IDE 的未来？"),l(n)])]),e("li",null,[e("a",U,[i("先不管那么多，offer 接了再说"),l(n)])]),e("li",null,[e("a",R,[i("一套 KTV 管理系统，估价 3 万还是 30 万？"),l(n)])]),e("li",null,[e("a",B,[i("给 offer 的公司不问技术细节？"),l(n)])]),e("li",null,[e("a",k,[i("入职一个月，就想跑路了？"),l(n)])])]),M])}const D=s(c,[["render",w],["__file","mybatiszyytszhwskczjsj.html.vue"]]);export{D as default};
