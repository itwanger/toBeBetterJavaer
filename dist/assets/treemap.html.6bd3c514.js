import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as r,c as l,a as e,d as n,b as t,e as s,r as d}from"./app.74ec0c3b.js";const o={},c=e("p",null,"TreeMap，虽然也是个 Map，但存在感太低了。我做程序员这十多年里，HashMap 用了超过十年，TreeMap 只用了多字里那么一小会儿一小会儿，真的是，太惨了。",-1),p=e("p",null,"虽然 TreeMap 用得少，但还是有用处的。",-1),u={href:"https://tobebetterjavaer.com/collection/linkedhashmap.html",target:"_blank",rel:"noopener noreferrer"},v=s(`<p>TreeMap 由红黑树实现，可以保持元素的自然顺序，或者实现了 Comparator 接口的自定义顺序。</p><p>可能有些同学不知道红黑树，理解起来 TreeMap 就有点难度，那我先来普及一下：</p><blockquote><p>红黑树（英语：Red–black tree）是一种自平衡的二叉查找树（Binary Search Tree），结构复杂，但却有着良好的性能，完成查找、插入和删除的时间复杂度均为 log(n)。</p></blockquote><p>二叉查找树又是什么呢？</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-c5f29a61-91e0-47e8-9e16-055e1bea5b33.jpg" alt="" loading="lazy"></p><p>上图中这棵树，就是一颗典型的二叉查找树：</p><p>1）左子树上所有节点的值均小于或等于它的根结点的值。</p><p>2）右子树上所有节点的值均大于或等于它的根结点的值。</p><p>3）左、右子树也分别为二叉排序树。</p><p>理解二叉查找树了吧？不过，二叉查找树有一个不足，就是容易变成瘸子，就是一侧多，一侧少，就像下图这样：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-6c3309a0-3737-4677-99c1-e8a156140d62.jpg" alt="" loading="lazy"></p><p>查找的效率就要从 log(n) 变成 o(n) 了，对吧？必须要平衡一下，对吧？于是就有了平衡二叉树，左右两个子树的高度差的绝对值不超过 1，就像下图这样：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-b8f74a3d-baf9-4192-a0e0-cdd07955d784.jpg" alt="" loading="lazy"></p><p>红黑树，顾名思义，就是节点是红色或者黑色的平衡二叉树，它通过颜色的约束来维持着二叉树的平衡：</p><p>1）每个节点都只能是红色或者黑色</p><p>2）根节点是黑色</p><p>3）每个叶节点（NIL 节点，空节点）是黑色的。</p><p>4）如果一个节点是红色的，则它两个子节点都是黑色的。也就是说在一条路径上不能出现相邻的两个红色节点。</p><p>5）从任一节点到其每个叶子的所有路径都包含相同数目的黑色节点。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-3373c98c-d82f-4a7f-949e-a7fe0d99314c.jpg" alt="" loading="lazy"></p><p>那，关于红黑树，同学们就先了解到这，脑子里有个大概的印象，知道 TreeMap 是个什么玩意。</p><h2 id="_01、自然顺序" tabindex="-1"><a class="header-anchor" href="#_01、自然顺序" aria-hidden="true">#</a> 01、自然顺序</h2><p>默认情况下，TreeMap 是根据 key 的自然顺序排列的。比如说整数，就是升序，1、2、3、4、5。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>TreeMap&lt;Integer,String&gt; mapInt = new TreeMap&lt;&gt;();
mapInt.put(3, &quot;沉默王二&quot;);
mapInt.put(2, &quot;沉默王二&quot;);
mapInt.put(1, &quot;沉默王二&quot;);
mapInt.put(5, &quot;沉默王二&quot;);
