import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as r,c as o,a as e,d as n,b as t,e as l}from"./app-1c5b5ce3.js";const s={},c=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/csdn-zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl-69c3cc92-4d31-467b-a15d-33e43fd4bade.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),u=e("br",null,null,-1),v=e("br",null,null,-1),p={href:"https://javabetter.cn",target:"_blank",rel:"noopener noreferrer"},b=e("p",null,"大家好，我是二哥呀！",-1),m=e("p",null,[n("本篇主要要介绍的就是"),e("code",null,"controller"),n("层的处理，一个完整的后端请求由4部分组成：1. "),e("code",null,"接口地址"),n("(也就是URL地址)、2. "),e("code",null,"请求方式"),n("(一般就是get、set，当然还有put、delete)、3. "),e("code",null,"请求数据"),n("(request，有head跟body)、4. "),e("code",null,"响应数据"),n("(response)")],-1),g={href:"https://blog.csdn.net/chaitoudaren/article/details/105610962",target:"_blank",rel:"noopener noreferrer"},h=l(`<p>本篇将解决以下3个问题：</p><ol><li>当接收到请求时，如何优雅的校验参数</li><li>返回响应数据该如何统一的进行处理</li><li>接收到请求，处理业务逻辑时抛出了异常又该如何处理</li></ol><h2 id="一、controller层参数接收-太基础了-可以跳过" tabindex="-1"><a class="header-anchor" href="#一、controller层参数接收-太基础了-可以跳过" aria-hidden="true">#</a> 一、Controller层参数接收（太基础了，可以跳过）</h2><p>常见的请求就分为<code>get</code>跟<code>post</code>2种</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@RestController
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>我们看到代码抛出了<code>org.springframework.validation.BindException</code>的绑定异常，因此我们的思路就是<code>AOP</code>拦截所有<code>controller</code>，然后异常的时候统一拦截起来，进行封装！完美！</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/csdn-zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl-48412c36-e140-4a00-9eb4-b90d2accb8a5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>玩你个头啊完美，这么呆瓜的操作<code>springboot</code>不知道吗？<code>spring mvc</code>当然知道拉，所以给我们提供了一个<code>@RestControllerAdvice</code>来增强所有<code>@RestController</code>，然后使用<code>@ExceptionHandler</code>注解，就可以拦截到对应的异常。</p><p>这里我们就拦截<code>BindException.class</code>就好了。最后在返回之前，我们对异常信息进行包装一下，包装成<code>ResultVo</code>，当然要跟上<code>ResultCode.VALIDATE_ERROR</code>的异常状态码。这样前端妹妹看到<code>VALIDATE_ERROR</code>的状态码，就会调用数据校验异常的弹窗提示用户哪里没填好</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@RestControllerAdvice
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>开发小哥肯定不乐意了，谁有空天天写<code>new ResultVo(data)</code>啊，我就想返回一个实体！怎么实现我不管！好把，那就是<code>AOP</code>拦截所有<code>Controller</code>，再<code>@After</code>的时候统一帮你封装一下咯</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/csdn-zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl-48412c36-e140-4a00-9eb4-b90d2accb8a5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>怕是上一次脸打的不够疼，springboot能不知道这么个操作吗？</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@RestControllerAdvice(basePackages = {&quot;com.bugpool.leilema&quot;})
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>公司部署了一套校验所有系统存活状态的工具，这工具就定时发送<code>get</code>请求给我们系统</p><blockquote><p>“兄弟，你死了吗？”</p><p>“我没死，滚”</p><p>“兄弟，你死了吗？”</p><p>“我没死，滚”</p></blockquote><p>是的，web项目的本质就是复读机。一旦发送的请求<code>没响应</code>，就会给负责人发信息（企业微信或者短信之类的），你的<code>系统死啦</code>！赶紧回来<code>排查bug</code>吧！让大家感受一下。每次看到我都<code>射射发抖</code>，早上6点！我tm！！！！！</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/csdn-zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl-9abb673b-9a5a-4a63-b103-089e5460da12.png" alt="监控" tabindex="0" loading="lazy"><figcaption>监控</figcaption></figure><p>好吧，没办法，人家是老大，人家要的返回不是</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{
  &quot;code&quot;: 1000,
  &quot;msg&quot;: &quot;请求成功&quot;,
  &quot;data&quot;: &quot;success&quot;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这时候就不会自动封装了，而其他没加注解的则依旧自动包装</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/csdn-zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl-67f4a389-dfe5-4275-aab3-3ae149603e6a.png" alt="noResponseAdvice" tabindex="0" loading="lazy"><figcaption>noResponseAdvice</figcaption></figure><h2 id="五、统一异常" tabindex="-1"><a class="header-anchor" href="#五、统一异常" aria-hidden="true">#</a> 五、统一异常</h2><p>每个系统都会有自己的<code>业务异常</code>，比如<code>库存不能小于0</code>子类的，这种异常并非程序异常，而是业务操作引发的异常，我们也需要进行规范的编排业务<code>异常状态码</code>，并且写一个专门处理的<code>异常类</code>，最后通过刚刚学习过的<code>异常拦截</code>统一进行处理，以及打<code>日志</code></p><ol><li>异常状态码枚举，既然是状态码，那就肯定要实现我们的标准接口<code>StatusCode</code></li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@Getter
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>就会自动抛出<code>AppCode.ORDER_NOT_EXIST</code>状态码的响应，并且带上异常详细信息<code>订单号不存在：xxxx</code>。后端小哥开发有效率，前端妹妹获取到<code>2003</code>状态码，调用对应警告弹窗，<code>title</code>写上<code>订单不存在</code>，<code>body</code>详细信息记载<code>&quot;订单号不存在：1998&quot;</code>。同时<code>日志</code>还自动打上去了！</p><hr>`,96),q={href:"https://github.com/itwanger/toBeBetterJavaer",target:"_blank",rel:"noopener noreferrer"},x={href:"https://javabetter.cn/overview/",target:"_blank",rel:"noopener noreferrer"},f=e("p",null,[n("微信搜 "),e("strong",null,"沉默王二"),n(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"222"),n(" 即可免费领取。")],-1),R=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function P(C,j){const i=a("ExternalLinkIcon");return r(),o("div",null,[c,e("p",null,[n("作者：沉默王二"),u,v,n(" 二哥的Java进阶之路："),e("a",p,[n("https://javabetter.cn"),t(i)])]),b,m,e("blockquote",null,[e("p",null,[n("文章链接："),e("a",g,[n("https://blog.csdn.net/chaitoudaren/article/details/105610962"),t(i)]),n(" 作者：bugpool 整理：沉默王二")])]),h,e("p",null,[n("GitHub 上标星 8700+ 的开源知识库《"),e("a",q,[n("二哥的 Java 进阶之路"),t(i)]),n("》第一版 PDF 终于来了！包括Java基础语法、数组&字符串、OOP、集合框架、Java IO、异常处理、Java 新特性、网络编程、NIO、并发编程、JVM等等，共计 32 万余字，可以说是通俗易懂、风趣幽默……详情戳："),e("a",x,[n("太赞了，GitHub 上标星 8700+ 的 Java 教程"),t(i)])]),f,R])}const y=d(s,[["render",P],["__file","zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl.html.vue"]]);export{y as default};
