...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="小结" tabindex="-1"><a class="header-anchor" href="#小结" aria-hidden="true">#</a> 小结</h3><p>PriorityQueue 是一个非常常用的数据结构，它是一种特殊的堆（Heap）实现，可以用来高效地维护一个有序的集合。</p><ul><li>它的底层实现是一个数组，通过堆的性质来维护元素的顺序。</li><li>取出元素时按照优先级顺序（从小到大或者从大到小）进行取出。</li><li>如果需要指定排序，元素必须实现 Comparable 接口或者传入一个 Comparator 来进行比较。</li></ul>`,75),d={href:"https://leetcode-cn.com/problems/merge-k-sorted-lists/",target:"_blank",rel:"noopener noreferrer"},p=n("p",null,"我把题解已经放到了技术派中，大家可以去作为参考。",-1),v={href:"https://paicoding.com/column/7/23",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/CarpenterLee/JCFInternals",target:"_blank",rel:"noopener noreferrer"},b=n("hr",null,null,-1),k={href:"https://github.com/itwanger/toBeBetterJavaer",target:"_blank",rel:"noopener noreferrer"},g={href:"https://javabetter.cn/overview/",target:"_blank",rel:"noopener noreferrer"},f=n("p",null,[e("微信搜 "),n("strong",null,"沉默王二"),e(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),n("strong",null,"222"),e(" 即可免费领取。")],-1),h=n("figure",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),n("figcaption")],-1);function x(y,Q){const a=t("ExternalLinkIcon");return l(),o("div",null,[u,n("p",null,[e("可以通过 LeetCode 的第 23 题："),n("a",d,[e("合并K个升序链表"),s(a)]),e(" 来练习 PriorityQueue 的使用。")]),p,n("p",null,[n("a",v,[e("合并K个升序链表"),s(a)])]),n("blockquote",null,[n("p",null,[e("参考链接："),n("a",m,[e("https://github.com/CarpenterLee/JCFInternals"),s(a)]),e("，作者：李豪，整理：沉默王二")])]),b,n("p",null,[e("GitHub 上标星 10000+ 的开源知识库《"),n("a",k,[e("二哥的 Java 进阶之路"),s(a)]),e("》第一版 PDF 终于来了！包括Java基础语法、数组&字符串、OOP、集合框架、Java IO、异常处理、Java 新特性、网络编程、NIO、并发编程、JVM等等，共计 32 万余字，500+张手绘图，可以说是通俗易懂、风趣幽默……详情戳："),n("a",g,[e("太赞了，GitHub 上标星 10000+ 的 Java 教程"),s(a)])]),f,h])}const _=i(r,[["render",x],["__file","PriorityQueue.html.vue"]]);export{_ as default};
