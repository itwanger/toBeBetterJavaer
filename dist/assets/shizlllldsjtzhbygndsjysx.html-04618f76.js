import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as t,c as r,a as e,d as i,b as s,e as d}from"./app-1c5b5ce3.js";const u={},c=d(`<p>当你加入一家电商公司的话，很有可能会被问到“红包雨🧧如何设计和实现”这个问题，今天就来和球友们聊一聊。</p><p>所谓的红包雨，就是指在某次活动中，红包会以<strong>雨滴</strong>的形式落下，用户点击屏幕上落下的红包，若抢到红包，红包会以现金的形式进入用户账户。</p><p>红包雨是一个典型的高并发场景，短时间内有海量请求访问服务端，为了让系统运行顺畅，抢红包一般会采用基于 <strong>Redis + Lua 脚本</strong>的设计方案。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-c1fd7dd9-3974-41e8-a22c-4a4d25f80e73.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_1-整体流程" tabindex="-1"><a class="header-anchor" href="#_1-整体流程" aria-hidden="true">#</a> 1 整体流程</h2><p>我们来分析下抢红包的整体流程 ：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-47986b38-a727-4894-935c-3675811c5069.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol><li>运营系统配置红包雨活动总金额以及红包个数，提前计算出各个红包的金额并存储到 Redis 中；</li><li>抢红包雨界面，用户点击屏幕上落下的红包，发起抢红包请求；</li><li>TCP 网关接收抢红包请求后，调用抢红包的 dubbo 服务，抢红包服务本质上就是执行 Lua 脚本，将结果通过 TCP 网关返回给前端；</li><li>用户若抢到红包，异步任务会从 Redis 中 获取抢得的红包信息，调用余额系统，将金额返回到用户账户。</li></ol><h2 id="_2-红包-redis-设计" tabindex="-1"><a class="header-anchor" href="#_2-红包-redis-设计" aria-hidden="true">#</a> 2 红包 Redis 设计</h2><p>抢红包有如下规则：</p><ul><li>同一活动，用户只能抢红包一次 ；</li><li>红包数量有限，一个红包只能被一个用户抢到。</li></ul><p>如下图，我们设计三种数据类型：</p><ol><li>运营预分配红包列表 ;</li></ol><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-24dd06eb-b6ba-4123-a4da-d546a4415528.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>队列元素 json 数据格式 ：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{
    //红包编号
    redPacketId : &#39;365628617880842241&#39; 
    //红包金额
    amount : &#39;12.21&#39;          
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>用户红包领取记录列表；</li></ol><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-ef69cad5-d918-40f8-a098-1f1155e1b50e.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>队列元素 json 数据格式：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{
    //红包编号
    redPacketId : &#39;365628617880842241&#39;
    //红包金额
    amount : &#39;12.21&#39;,
...
&quot;hello world&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-3-evalsha-命令" tabindex="-1"><a class="header-anchor" href="#_5-3-evalsha-命令" aria-hidden="true">#</a> 5.3 EVALSHA 命令</h3><p>使用 EVAL 命令每次请求都需要传输 Lua 脚本 ，若 Lua 脚本过长，不仅会消耗网络带宽，而且也会对 Redis 的性能造成一定的影响。</p><p>思路是先将 Lua 脚本先缓存起来 , 返回给客户端 Lua 脚本的 sha1 摘要。 客户端存储脚本的 sha1 摘要 ，每次请求执行 EVALSHA 命令即可。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-80555399-ce33-4a0d-baf6-56cb55da5aa6.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>EVALSHA 命令基本语法如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>redis&gt; EVALSHA sha1 numkeys key [key ...] arg [arg ...] 
...
&quot;hello world&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-事务-vs-lua-脚本" tabindex="-1"><a class="header-anchor" href="#_5-4-事务-vs-lua-脚本" aria-hidden="true">#</a> 5.4 事务 VS Lua 脚本</h3>`,133),o=e("p",null,"从定义上来说， Redis 中的脚本本身就是一种事务， 所以任何在事务里可以完成的事， 在脚本里面也能完成。 并且一般来说， 使用脚本要来得更简单，并且速度更快。",-1),v=e("p",null,"因为脚本功能是 Redis 2.6 才引入的， 而事务功能则更早之前就存在了， 所以 Redis 才会同时存在两种处理事务的方法。",-1),b=e("p",null,"不过我们并不打算在短时间内就移除事务功能， 因为事务提供了一种即使不使用脚本， 也可以避免竞争条件的方法， 而且事务本身的实现并不复杂。",-1),m={href:"https://redis.io/",target:"_blank",rel:"noopener noreferrer"},g=d(`<p>Lua 脚本是另一种形式的事务，他具备一定的原子性，但脚本报错的情况下，事务并不会回滚。Lua 脚本可以保证隔离性，而且可以完美的支持<strong>后面的步骤依赖前面步骤的结果</strong>。</p><p>综上，Lua 脚本是抢红包场景最优的解决方案。</p><p>但在编写 Lua 脚本时，要注意如下两点：</p><ol><li>为了避免 Redis 阻塞，Lua 脚本业务逻辑不能过于复杂和耗时；</li><li>仔细检查和测试 Lua 脚本 ，因为执行 Lua 脚本具备一定的原子性，不支持回滚。</li></ol><h2 id="_6-实战准备" tabindex="-1"><a class="header-anchor" href="#_6-实战准备" aria-hidden="true">#</a> 6 实战准备</h2><p>我选择 Redisson 3.12.0 版本作为 Redis 的客户端，在 Redisson 源码基础上做一层薄薄的封装。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-46036f01-d57c-441e-9584-299e1b3ee7cd.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>创建一个 PlatformScriptCommand 类， 用来执行 Lua 脚本。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 加载 Lua 脚本 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-写到最后" tabindex="-1"><a class="header-anchor" href="#_9-写到最后" aria-hidden="true">#</a> 9 写到最后</h2><blockquote><p>&quot;<strong>纸上得来终觉浅, 绝知此事要躬行</strong>&quot; 。</p></blockquote><p>学习 Redis Lua 过程中，查询了很多资料，一个例子一个例子的实践，收获良多。</p><p>非常坦诚的讲 ,  写这篇文章之前，我对 Redis Lua 有很多<strong>想当然</strong>的理解，比如 Redis 的事务不能回滚就让我惊讶不已。</p><p>所以当面对自己不熟悉的知识点时，不要轻易下结论，以谦卑的心态去学习，才是一个工程师需要的心态。</p><p>同时，没有任何一项技术是完美的，在设计和编码之间，有这样或者那样的平衡，这才是真实的世界。</p>`,37),p={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+794&idx=2&sn=c3e404938b5f348514286576b6977d66&chksm=fc2c7ff2cb5bf6e44f9ba46bae686a8a3f45bf03840926d2b9db9d0e9b278016b54ce689f12d#rd",target:"_blank",rel:"noopener noreferrer"};function h(x,f){const n=l("ExternalLinkIcon");return t(),r("div",null,[c,e("blockquote",null,[o,v,b,e("p",null,[i("-- "),e("a",m,[i("https://redis.io/"),s(n)])])]),g,e("blockquote",null,[e("p",null,[i("参考链接："),e("a",p,[i("https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+794&idx=2&sn=c3e404938b5f348514286576b6977d66&chksm=fc2c7ff2cb5bf6e44f9ba46bae686a8a3f45bf03840926d2b9db9d0e9b278016b54ce689f12d#rd"),s(n)])])])])}const E=a(u,[["render",h],["__file","shizlllldsjtzhbygndsjysx.html.vue"]]);export{E as default};
