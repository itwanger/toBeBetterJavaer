...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_5-结语" tabindex="-1"><a class="header-anchor" href="#_5-结语" aria-hidden="true">#</a> 5. 结语</h2><p>最后，谈谈二哥对 DDD 的理解，我觉得 DDD 不像一门技术，我理解的技术比如高并发、缓存、消息队列等，<strong>DDD 更像是一项软技能，一种方法论，包含了很多设计理念。</strong></p><p>大家不要认为，掌握了一些概念，以及 DDD 的基本思想，就掌握了 DDD，然后做项目时，照葫芦画瓢，这样你会死的很惨！</p><p>只掌握 DDD 表面的东西，其实是不够的，<strong>我觉得 DDD 最复杂的地方，其实是在它的领域设计部分</strong>，项目启动前，你一定要设计各个领域对象，以及它们直接的交互关系。</p><p>比如我们之前做过一个项目，因为这块没有做好，大家一边写代码，一边还在思考，这个领域对象该如何构造，严重影响开发效率，<strong>最后又不得不回退到 MVC 的模式。</strong></p><p>不要为了炫技，啥都要搞个 DDD，两者如何选择：</p><ul><li><strong>MVC</strong>：上来就可以开干，短平快，<strong>前期用起来很香，整体开发效率也更高</strong>，所以对于紧急，或者不那么重要的项目，我会直接用 MVC 怼，不好的地方就是，后面会越来越复杂，可能最后就是一坨屎山，<strong>但是很多时候，比如老板进度催的紧，我哪想到那么多以后呢？</strong></li><li><strong>DDD</strong>：前期需要花大量时间设计好领域模型，<strong>对于一些基础组件，或者一些核心服务，如果对象模型非常复杂，建议采用 DDD</strong>，前期可能会稍微痛苦一些，但是后期维护起来会非常方便。</li></ul><hr><p><em>没有什么使我停留——除了目的，纵然岸旁有玫瑰、有绿荫、有宁静的港湾，我是不系之舟</em>。</p><p><strong>推荐阅读</strong>：</p>`,15),j={href:"https://mp.weixin.qq.com/s/XWwqzrHAJ0vtY3lNilqVkg",target:"_blank",rel:"noopener noreferrer"},y={href:"https://mp.weixin.qq.com/s/gb48ZAqDCwXInUWM7q0EaQ",target:"_blank",rel:"noopener noreferrer"},z={href:"https://mp.weixin.qq.com/s/-LNhq_OBHDBZzAEMurqBJw",target:"_blank",rel:"noopener noreferrer"},R={href:"https://mp.weixin.qq.com/s/PZcWj0NbWRGdS0I9ACMqbg",target:"_blank",rel:"noopener noreferrer"},w=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-ganlygyddddywdnzw-a487294e-13a8-402c-afc6-e63baffa671b.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),A=e("hr",null,null,-1),U={href:"https://github.com/itwanger/toBeBetterJavaer",target:"_blank",rel:"noopener noreferrer"},T={href:"https://tobebetterjavaer.com/overview/",target:"_blank",rel:"noopener noreferrer"},E=e("p",null,[i("微信搜 "),e("strong",null,"沉默王二"),i(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"222"),i(" 即可免费领取。")],-1),C=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function q(I,P){const n=t("ExternalLinkIcon");return r(),s("div",null,[e("blockquote",null,[e("p",null,[e("a",c,[i("二哥编程知识星球"),a(n)]),i(" （戳链接加入）正式上线了，来和 "),u,i(" 小伙伴一起打怪升级吧！这是一个 Java 学习指南 + 编程实战的私密圈子，你可以向二哥提问、帮你制定学习计划、跟着二哥一起做实战项目，冲冲冲。"),o,m,i(" Java程序员进阶之路网址："),e("a",b,[i("https://tobebetterjavaer.com"),a(n)])])]),p,e("ul",null,[h,g,D,f,e("li",null,[e("p",null,[i("请求 URL："),e("a",_,[i("http://127.0.0.1:8087/api/user/save"),a(n)])])]),x]),O,e("ul",null,[e("li",null,[e("a",j,[i("我扔进垃圾桶的第一本 Java 书..."),a(n)])]),e("li",null,[e("a",y,[i("一键部署 Spring Boot 项目"),a(n)])]),e("li",null,[e("a",z,[i("离开北京？"),a(n)])]),e("li",null,[e("a",R,[i("编程喵实战项目可以在本地跑起来辣！"),a(n)])])]),w,A,e("p",null,[i("GitHub 上标星 7600+ 的开源知识库《"),e("a",U,[i("二哥的 Java 进阶之路"),a(n)]),i("》第一版 PDF 终于来了！包括Java基础语法、数组&字符串、OOP、集合框架、Java IO、异常处理、Java 新特性、网络编程、NIO、并发编程、JVM等等，共计 32 万余字，可以说是通俗易懂、风趣幽默……详情戳："),e("a",T,[i("太赞了，GitHub 上标星 7600+ 的 Java 教程"),a(n)])]),E,C])}const M=l(v,[["render",q],["__file","ganlygyddddywdnzw.html.vue"]]);export{M as default};
