...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>就会自动抛出<code>AppCode.ORDER_NOT_EXIST</code>状态码的响应，并且带上异常详细信息<code>订单号不存在：xxxx</code>。后端小哥开发有效率，前端妹妹获取到<code>2003</code>状态码，调用对应警告弹窗，<code>title</code>写上<code>订单不存在</code>，<code>body</code>详细信息记载<code>&quot;订单号不存在：1998&quot;</code>。同时<code>日志</code>还自动打上去了！</p><hr>`,96),h={href:"https://github.com/itwanger/toBeBetterJavaer",target:"_blank",rel:"noopener noreferrer"},q={href:"https://tobebetterjavaer.com/overview/",target:"_blank",rel:"noopener noreferrer"},x=e("p",null,[n("微信搜 "),e("strong",null,"沉默王二"),n(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"222"),n(" 即可免费领取。")],-1),f=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function R(P,C){const i=l("ExternalLinkIcon");return a(),r("div",null,[c,e("p",null,[n("作者：沉默王二"),u,n(" Java程序员进阶之路："),e("a",v,[n("https://tobebetterjavaer.com"),t(i)])]),p,b,e("blockquote",null,[e("p",null,[n("文章链接："),e("a",m,[n("https://blog.csdn.net/chaitoudaren/article/details/105610962"),t(i)]),n(" 作者：bugpool 整理：沉默王二")])]),g,e("p",null,[n("GitHub 上标星 7600+ 的开源知识库《"),e("a",h,[n("二哥的 Java 进阶之路"),t(i)]),n("》第一版 PDF 终于来了！包括Java基础语法、数组&字符串、OOP、集合框架、Java IO、异常处理、Java 新特性、网络编程、NIO、并发编程、JVM等等，共计 32 万余字，可以说是通俗易懂、风趣幽默……详情戳："),e("a",q,[n("太赞了，GitHub 上标星 7600+ 的 Java 教程"),t(i)])]),x,f])}const A=d(s,[["render",R],["__file","zhenggjspringbootrhclcsxytyyctyxybugpooldbkcsdnbkzgjspringbootrhcl.html.vue"]]);export{A as default};
