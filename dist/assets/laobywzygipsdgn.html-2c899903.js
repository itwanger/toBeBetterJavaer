...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>可以通过分别设置 cache-policy 为 file/vectorIndex/content 来测试三种不同缓存实现的效果。@Note: 注意 bench 使用的 src 文件要是生成对应 xdb 文件相同的源文件。</p><blockquote><p>到这里获取用户 IP 属地已经完成啦，这篇文章介绍的 v2.0 版本，有兴趣的小伙伴可以登录上门的 github 地址了解下 v1.0 版本</p></blockquote>`,51);function g(h,x){const d=l("ExternalLinkIcon");return r(),s("div",null,[o,i("p",null,[e("地址："),i("a",v,[e("https://ip.taobao.com/"),t(d)]),e("。")]),u,i("p",null,[b,e("，github 地址："),i("a",p,[e("https://github.com/lionsoul2014/ip2region"),t(d)])]),m])}const q=a(c,[["render",g],["__file","laobywzygipsdgn.html.vue"]]);export{q as default};
