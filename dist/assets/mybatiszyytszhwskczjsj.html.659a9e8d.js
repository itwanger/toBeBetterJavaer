...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用" aria-hidden="true">#</a> 基本使用</h2><blockquote><p>下面我们来聊聊MyBatis的基本使用方法，涵盖了基本的增删改查操作。</p></blockquote><h3 id="表结构说明" tabindex="-1"><a class="header-anchor" href="#表结构说明" aria-hidden="true">#</a> 表结构说明</h3><p>这里将以mall项目中权限管理模块相关表为例进行介绍，具体表结构如下。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-mybatiszyytszhwskczjsj-e4c9fdba-fef0-43bf-9d1b-a58b1eae41e8.jpg" alt="" loading="lazy"></p><h3 id="项目结构说明" tabindex="-1"><a class="header-anchor" href="#项目结构说明" aria-hidden="true">#</a> 项目结构说明</h3><p>本文示例使用了<code>mall-learning</code>项目中的<code>mall-tiny-mybatis</code>模块代码，具体项目结构如下。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-mybatiszyytszhwskczjsj-89145395-c273-4300-8ec3-1676c2a4a855.jpg" alt="" loading="lazy"></p><h3 id="select" tabindex="-1"><a class="header-anchor" href="#select" aria-hidden="true">#</a> select</h3><ul><li>首先是查询操作，这里我们以后台用户表<code>ums_admin</code>为例，编写一个<code>根据ID查询用户</code>的方法，先创建实体类<code>UmsAdmin</code>；</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class UmsAdmin implements Serializable {
    private Long id;
