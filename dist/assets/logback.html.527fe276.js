import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as o,a as n,d as e,b as s,e as t,r as c}from"./app.74ec0c3b.js";const r={},d=t(`<h2 id="关于-logback" tabindex="-1"><a class="header-anchor" href="#关于-logback" aria-hidden="true">#</a> 关于 Logback</h2><p>日志系统是一个线上项目必备的素质之一，代表性的日志框架 Log4j、SLF4J、Logback 这哥仨竟然是亲兄弟，他们有一个亲爹，那就是巨佬 Ceki Gulcu。</p><p>由于 Spring Boot 的默认日志框架选用的 Logback，再加上 Log4j2 之前爆过严重的漏洞，所以我们这次就只关注 Logback。</p><p>1）Logback 非常自然地实现了 SLF4J，不需要像 Log4j 和 JUL 那样加一个适配层。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/logback-67c983bf-101d-48cc-80da-3cb031d7407b.png" alt="" loading="lazy"></p><p>2）Spring Boot 的默认日志框架使用的是 Logback，启动编程喵项目的时候就可以看到 Logback 记录的日志了。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/logback-a2cacfa1-484a-4904-bea3-248d12097387.png" alt="" loading="lazy"></p><p>怎么看出来是 logback 呢？</p><p>说实话，看不出来，哈哈哈，不过可以从 Spring Boot 官网找到证据。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/logback-9ac58c2c-e7f9-4df7-aede-ba7d5c69741c.png" alt="" loading="lazy"></p><p>还有，通过源码也可以窥见一二。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/logback-7a10bd7b-598a-4c30-9c83-b80689671f41.png" alt="" loading="lazy"></p><p>3）logback 分为三个模块：</p><ul><li>logback-core，核心模块，提供了关键的通用机制；</li><li>logback-classic，可以看作是 log4j 的改进版，实现了简单的日志门面 SLF4J；</li><li>logback-access，主要用来和 Servlet 容器交互，比如说 Tomcat，提供了一些 HTTP 访问的功能。</li></ul><p>如果想研究 logback 源码的话，可以按照这三个模块去研究。</p><h2 id="直接上手" tabindex="-1"><a class="header-anchor" href="#直接上手" aria-hidden="true">#</a> 直接上手</h2><p>不废话，直接新建一个空的 Spring Boot 项目，在测试类中加上两行代码。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@SpringBootTest</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>再次运行测试类，可以在控制台看到以下信息：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/logback-05b134ab-b6e6-4a10-a00c-41b829938618.png" alt="" loading="lazy"></p><p>也就是说，Logback 会在 classpath 路径下先寻找 logback-test.xml 文件，没有找到的话，寻找 logback.xml 文件，都找不到的话，就输出到控制台。</p><p>并且，Logger 的默认日志级别是 INFO 级别的，这就意味着如果尝试下面的代码：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>logger<span class="token punctuation">.</span><span class="token function">debug</span><span class="token punctuation">(</span><span class="token string">&quot;沉默王二是傻 X&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>`,19),u={href:"https://tobebetterjavaer.com/zhishixingqiu/",target:"_blank",rel:"noopener noreferrer"},v=n("strong",null,"编程喵",-1),b=n("hr",null,null,-1),m=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/logback-cd491159-e48e-4c74-a67f-7962a45e847f.png",alt:"",loading:"lazy"})],-1),k=n("h2",{id:"源码路径",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#源码路径","aria-hidden":"true"},"#"),e(" 源码路径")],-1),h={href:"https://github.com/itwanger/coding-more",target:"_blank",rel:"noopener noreferrer"},q={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-logback",target:"_blank",rel:"noopener noreferrer"},y=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",loading:"lazy"})],-1);function L(f,_){const a=c("ExternalLinkIcon");return i(),o("div",null,[d,n("blockquote",null,[n("p",null,[n("a",g,[e("https://github.com/spring-projects/spring-boot/blob/main/spring-boot-project/spring-boot/src/main/java/org/springframework/boot/logging/logback/DefaultLogbackConfiguration.java"),s(a)])])]),p,n("p",null,[e("更多内容，只针对《Java 程序员进阶之路》星球用户开放，需要的小伙伴可以"),n("a",u,[e("戳链接🔗"),s(a)]),e("加入我们的星球，一起学习，一起卷。。"),v,e("🐱是一个 Spring Boot+Vue 的前后端分离项目，融合了市面上绝大多数流行的技术要点。通过学习实战项目，你可以将所学的知识通过实践进行检验、你可以拓宽自己的技术边界，你可以掌握一个真正的实战项目是如何从 0 到 1 的。")]),b,m,k,n("blockquote",null,[n("ul",null,[n("li",null,[e("编程喵："),n("a",h,[e("https://github.com/itwanger/coding-more"),s(a)])]),n("li",null,[e("Logback 详细配置专用："),n("a",q,[e("https://github.com/itwanger/coding-more"),s(a)])])])]),y])}const S=l(r,[["render",L],["__file","logback.html.vue"]]);export{S as default};
