...
$ git archive
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="六、图解-git-分支" tabindex="-1"><a class="header-anchor" href="#六、图解-git-分支" aria-hidden="true">#</a> 六、图解 Git 分支</h2><p>相比同类软件，Git有很多优点。其中很显著的一点，就是版本的分支（branch）和合并（merge）十分方便。</p><p>有些传统的版本管理软件，分支操作实际上会生成一份现有代码的物理拷贝，而Git只生成一个指向当前版本（又称&quot;快照&quot;）的指针，因此非常快捷易用。</p><p>但是，太方便了也会产生副作用。如果你不加注意，很可能会留下一个枝节蔓生、四处开放的版本库，到处都是分支，完全看不出主干发展的脉络。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-01.png" alt="" loading="lazy"></p><p>那有没有一个好的分支策略呢？答案当然是有的。</p><h3 id="_1、主分支master" tabindex="-1"><a class="header-anchor" href="#_1、主分支master" aria-hidden="true">#</a> 1、主分支Master</h3><p>首先，代码库应该有一个、且仅有一个主分支。所有提供给用户使用的正式版本，都在这个主分支上发布。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-02.png" alt="" loading="lazy"></p><p>Git主分支的名字，默认叫做Master。它是自动建立的，版本库初始化以后，默认就是在主分支在进行开发。</p><h3 id="_2、开发分支develop" tabindex="-1"><a class="header-anchor" href="#_2、开发分支develop" aria-hidden="true">#</a> 2、开发分支Develop</h3><p>主分支只用来发布重大版本，日常开发应该在另一条分支上完成。我们把开发用的分支，叫做Develop。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-03.png" alt="" loading="lazy"></p><p>这个分支可以用来生成代码的最新隔夜版本（nightly）。如果想正式对外发布，就在Master分支上，对Develop分支进行&quot;合并&quot;（merge）。</p><p>Git创建Develop分支的命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>　　git checkout -b develop master
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里稍微解释一下上一条命令的--no-ff参数是什么意思。默认情况下，Git执行&quot;快进式合并&quot;（fast-farward merge），会直接将Master分支指向Develop分支。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-04.png" alt="" loading="lazy"></p><p>使用--no-ff参数后，会执行正常合并，在Master分支上生成一个新节点。为了保证版本演进的清晰，我们希望采用这种做法。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-05.png" alt="" loading="lazy"></p><h3 id="_3、临时性分支" tabindex="-1"><a class="header-anchor" href="#_3、临时性分支" aria-hidden="true">#</a> 3、临时性分支</h3><p>前面讲到版本库的两条主要分支：Master和Develop。前者用于正式发布，后者用于日常开发。其实，常设分支只需要这两条就够了，不需要其他了。</p><p>但是，除了常设分支以外，还有一些临时性分支，用于应对一些特定目的的版本开发。临时性分支主要有三种：</p><ul><li>功能（feature）分支</li><li>预发布（release）分支</li><li>修补bug（fixbug）分支</li></ul><p>这三种分支都属于临时性需要，使用完以后，应该删除，使得代码库的常设分支始终只有Master和Develop。</p><p>接下来，一个个来看这三种&quot;临时性分支&quot;。</p><p><strong>第一种是功能分支</strong>，它是为了开发某种特定功能，从Develop分支上面分出来的。开发完成后，要再并入Develop。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-06.png" alt="" loading="lazy"></p><p>功能分支的名字，可以采用feature-*的形式命名。</p><p>创建一个功能分支：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>　　git checkout -b feature-x develop
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>最后一种是修补bug分支</strong>。软件正式发布以后，难免会出现bug。这时就需要创建一个分支，进行bug修补。</p><p>修补bug分支是从Master分支上面分出来的。修补结束以后，再合并进Master和Develop分支。它的命名，可以采用fixbug-*的形式。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/fenzhi-07.png" alt="" loading="lazy"></p><p>创建一个修补bug分支：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>　　git checkout -b fixbug-0.1 master
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="七、git-实战" tabindex="-1"><a class="header-anchor" href="#七、git-实战" aria-hidden="true">#</a> 七、Git 实战</h2><p>对于新手来说，Git 操作确实容易给代码的版本库带来一些不必要的混乱，毕竟大学的时候，学习的重点在编程语言上，在计算机基础上。可一旦参加了工作，就必须得在代码版本库上狠下一番功夫了，毕竟要多人运动啊，不，多人协作啊。</p><h3 id="_1、创建仓库" tabindex="-1"><a class="header-anchor" href="#_1、创建仓库" aria-hidden="true">#</a> 1、创建仓库</h3><p>仓库，也就是 repository，可以简单理解为一个目录，这个目录里面的所有文件都将被 Git 管理起来，每个文件的一举一动，都将被 Git 记录下来，以便在任何时刻进行追踪和回滚。</p><p>新建一个文件夹，比如说 testgit，然后使用 <code>git init</code> 命令就可以把这个文件夹初始化为 Git 仓库了。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-01.png" alt="" loading="lazy"></p><p>初始化Git 仓库成功后，可以看到多了一个 .git 的目录，没事不要乱动，免得破坏了 Git 仓库的结构。</p><p>接下来，我们来新增一个文件 readme.txt，内容为“老铁，记得给二哥三连啊”，并将其提交到 Git 仓库。</p><p>第一步，使用 <code>git add</code> 命令将新增文件添加到暂存区。</p><p>第二步，使用 <code>git commit</code> 命令告诉 Git，把文件提交到仓库。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-02.png" alt="" loading="lazy"></p><p>可以使用 <code>git status</code> 来查看是否还有文件未提交。</p><p>也可以在文件中新增一行内容“传统美德不能丢，记得点赞哦~”，再使用 <code>git status</code> 来查看结果。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-03.png" alt="" loading="lazy"></p><p>如果想查看文件到底哪里做了修改，可以使用 <code>git diff</code> 命令：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-04.png" alt="" loading="lazy"></p><p>确认修改的内容后，可以使用 <code>git add</code> 和 <code>git commit</code> 再次提交。</p><h3 id="_2、版本回滚" tabindex="-1"><a class="header-anchor" href="#_2、版本回滚" aria-hidden="true">#</a> 2、版本回滚</h3><p>再次对文件进行修改，追加一行内容为：“xxx，我爱你❤”，并且提交到 Git 仓库。</p><p>现在我已经对 readme.txt 文件做了三次修改了。可以通过 <code>git log</code> 命令来查看历史记录：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-05.png" alt="" loading="lazy"></p><p>也可以通过 <code>gitk</code> 这个命令来启动图形化界面来查看版本历史。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-06.png" alt="" loading="lazy"></p><p>如果想回滚的话，比如说回滚到上一个版本，可以执行以下两种命令：</p><p>1）<code>git reset --hard HEAD^</code>，上上个版本就是 <code>git reset --hard HEAD^^</code>，以此类推。</p><p>2）<code>git reset --hard HEAD~100</code>，如果回滚到前 100 个版本，用这个命令比上一个命令更方便。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-07.png" alt="" loading="lazy"></p><p>那假如回滚错了，想恢复，不记得版本号了，可以先执行 <code>git reflog</code> 命令查看版本号：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-08.png" alt="" loading="lazy"></p><p>然后再通过 <code>git reset --hard</code> 命令来恢复：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-09.png" alt="" loading="lazy"></p><h3 id="_3、工作区和暂存区的区别" tabindex="-1"><a class="header-anchor" href="#_3、工作区和暂存区的区别" aria-hidden="true">#</a> 3、工作区和暂存区的区别</h3><p>工作区和暂存区的概念其实在前面的章节里强调过了，但考虑到有些小伙伴在 <code>git add</code> 和 <code>git commit</code> 命令之间仍然有一些疑惑，我们这里就再强调一次——学习知识就是这样，只有不厌其烦地重复，才能真正地理解和掌握。</p><p>1）<strong>工作区</strong>，比如说前面提到的 testgit 目录就属于工作区，我们操作的 readme.txt 文件就放在这个里面。</p><p>2）<strong>暂存区</strong>，隐藏目录 .git 不属于工作区，它（Git 仓库）里面存了很多东西，其中最重要的就是暂存区。</p><p>Git 在提交文件的时候分两步，第一步 <code>git add</code> 命令是把文件添加到暂存区，第二步 <code>git commit</code> 才会把暂存区的所有内容提交到 Git 仓库中。</p><p>“<strong>为什么要先 add 才能 commit 呢？</strong>”</p><p>最直接的原因就是Linus 搞了这个“暂存区”的概念。那为什么要搞这个概念呢？没有暂存区不行吗？</p><p>嗯，要回答这个问题，我们就需要追本溯源了。</p><p>在 Git 之前， SVN 是代码版本管理系统的集大成者。SVN 比之前的 CVS 更优秀的一点是，每次的提交可以由多个文件组成，并且这次提交是原子性的，要么全部成功，要么全部失败。</p><p>原子性带来的好处是显而易见的，这使得我们可以把项目整体还原到某个时间点，就这一点，SVN 就完虐 CVS 这些代码版本管理系统了。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-10.png" alt="" loading="lazy"></p><p>Git 作为逼格最高的代码版本管理系统，自然要借鉴 SVN 这个优良特性的。但不同于 SVN 的是，Git 一开始搞的都是命令行，没有图形化界面，如果想要像 SVN 那样一次性选择多个文件或者不选某些文件（见上图），还真特喵的是个麻烦事。</p><p>对于像 Linus 这种天才级选手来说，图形化界面无疑是 low 逼，可命令行在这种情况下又实在是麻烦~</p><p>嗯，怎么办呢？</p><p>神之所以为神，就是他能在遇到问题的时候想到完美的解决方案——搞个<strong>暂存区</strong>不就完事了？</p><p>暂存区可以随意地将各种文件的修改放进去，只需要通过 <code>git add</code> 这种简单的命令就可以精心地挑选要提交哪些文件了，然后再一次性（原子性）的 <code>git commit</code> 到版本库，所有的问题都迎刃而解嘛。</p><p>我们在 testgit 目录下再新增一个文件 readyou.txt，内容为“二哥，我要和你约饭~~~”；并且在 readme.txt 文件中再追加一行内容“点赞、在看、留言、转发一条龙服务~”。</p><p>我们先用 <code>git status</code> 命令查看一下状态，再用 <code>git add</code> 将文件添加到暂存区，最后再用 <code>git commit</code> 一次性提交到 Git 仓库。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-11.png" alt="" loading="lazy"></p><h3 id="_4、撤销修改" tabindex="-1"><a class="header-anchor" href="#_4、撤销修改" aria-hidden="true">#</a> 4、撤销修改</h3><p>现在，我在 readyou.txt 文件中追加了一行内容：“二哥，我想和你约会~~~”。在我想要提交的时候，突然发现追加的内容有误，我得恢复到以前的版本，该怎么办呢？</p><p>1）我知道要修改的内容，直接修改，然后 add 和 commit 覆盖。</p><p>2）我忘记要修改哪些内容了，通过 <code>git reset -- hard HEAD</code> 恢复到上一个版本。</p><p>还有其他办法吗？</p><p>答案当然是有了，其实在我们执行 <code>git status</code> 命令查看 Git 状态的时候，结果就提示我们可以使用 <code>git restore</code> 命令来撤销这次操作的。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-12.png" alt="" loading="lazy"></p><p>那其实在 git version 2.23.0 版本之前，是可以通过 <code>git checkout</code> 命令来完成撤销操作的。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-13.png" alt="" loading="lazy"></p><p>checkout 可以创建分支、导出分支、切换分支、从暂存区删除文件等等，一个命令有太多功能就容易让人产生混淆。2.23.0 版本改变了这种混乱局面，git switch 和 git restore 两个新的命令应运而生。</p><p>switch 专注于分支的切换，restore 专注于撤销修改。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-14.png" alt="" loading="lazy"></p><h3 id="_5、远程仓库" tabindex="-1"><a class="header-anchor" href="#_5、远程仓库" aria-hidden="true">#</a> 5、远程仓库</h3><p>Git 是一款分布式版本控制系统，所以同一个 Git 仓库，可以分布到不同的机器上。一开始，只有一台机器和一个原始版本库，往后去，别的机器就可以从这台机器上拷贝原始版本，就像黑客帝国里的那个特工史密斯一样，没有任何区别。</p><p>这也是 Git 比集中式版本控制系统 SVN 特别的地方之一。</p><p>我们可以自己搭建一台每天 24 小时可以运转的 Git 服务器，然后其他人就从这台“服务器”中拷贝就行了。不过，因为 GitHub 的存在，自主搭建 Git 服务器这个步骤就可以省了。</p><p>从名字上就可以看得出来，GitHub 是用来提供 Git 仓库托管服务的，我们<strong>只需要注册一个 GitHub 账号</strong>，就可以免费获取一台每天可以运转 24 小时的 Git 远程服务器。</p><p>那其实在 GitHub 上有对应的中文帮助文档，来介绍如何通过 SSH 协议将本机和 GitHub 链接起来，从而不必在每次访问时提供用户名和密码。</p>`,147),f={href:"https://docs.github.com/cn/authentication/connecting-to-github-with-ssh/about-ssh",target:"_blank",rel:"noopener noreferrer"},G=a(`<p><strong>第一步，通过 <code>ls -al ~/.ssh</code> 命令检查 SSH 密钥是否存在</strong></p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-15.png" alt="" loading="lazy"></p><p>如果没有 id_rsa.pub、id_ecdsa.pub、id_ed25519.pub 这 3 个文件，表示密钥不存在。</p><p><strong>第二步，生成新 SSH 密钥</strong></p><p>执行以下命令，注意替换成你的邮箱：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ssh-keygen -t ed25519 -C &quot;your_email@example.com&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>然后一路回车：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-16.png" alt="" loading="lazy"></p><p>记得复制一下密钥，在 id_ed25519.pub 文件中：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-17.png" alt="" loading="lazy"></p><p><strong>第三步，添加 SSH 密钥到 GitHub 帐户</strong></p><p>在个人账户的 settings 菜单下找到 SSH and GPG keys，将刚刚复制的密钥添加到 key 这一栏中，点击「add SSH key」提交。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-18.png" alt="" loading="lazy"></p><p>Title 可不填写，提交成功后会列出对应的密钥：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-19.png" alt="" loading="lazy"></p><p><strong>为什么 GitHub 需要 SSH 密钥呢</strong>？</p><p>因为 GitHub 需要确认是“你本人”在往你自己的远程仓库上提交版本的，而不是别人冒充的。</p><p><strong>第四步，在 GitHub 上创建个人仓库</strong></p><p>点击新建仓库，填写仓库名称等信息：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-20.png" alt="" loading="lazy"></p><p><strong>第五步，把本地仓库同步到 GitHub</strong></p><p>复制远程仓库的地址：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-21.png" alt="" loading="lazy"></p><p>在本地仓库中执行 <code>git remote add</code> 命令将 GitHub 仓库添加到本地：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-22.png" alt="" loading="lazy"></p><p>当我们第一次使用Git 的 push 命令连接 GitHub 时，会得到一个警告⚠️：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>The authenticity of host &#39;github.com (20.205.243.166)&#39; can&#39;t be established.
ECDSA key fingerprint is SHA256:p2QAMXNIC1TJYWeIOttrVc98/R1BUFWu3/LiyKgUfQM.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这是因为需要你手动确认，输入 yes 即可。</p><p>接下来，我们使用 <code>git push</code> 命令将当前本地分支推送到 GitHub。加上了 -u 参数后，Git 不但会把本地的 master 分支推送的远程 master 分支上，还会把本地的 master 分支和远程的master 分支关联起来，在以后的推送或者拉取时就可以简化命令（比如说 <code>git push github master</code>）。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-23.png" alt="" loading="lazy"></p><p>此时，我们刷一下 GitHub，可以看到多了一个 master 分支，并且本地的两个文件都推送成功了！</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-24.png" alt="" loading="lazy"></p><p>从现在开始，只要本地做了修改，就可以通过 <code>git push</code> 命令推送到 GitHub 远程仓库了。</p><p>还可以使用 <code>git clone</code> 命令将远程仓库拷贝到本地。比如说我现在有一个 3.4k star 的仓库 JavaBooks，</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-25.png" alt="" loading="lazy"></p><p>然后我使用 <code>git clone</code> 命令将其拷贝到本地。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/jibenshiyong-26.png" alt="" loading="lazy"></p><h2 id="八、详解-sparse-checkout-命令" tabindex="-1"><a class="header-anchor" href="#八、详解-sparse-checkout-命令" aria-hidden="true">#</a> 八、详解 sparse-checkout 命令</h2><p>前天不是搭建了一个《Java 程序员进阶之路》的网站嘛，其中用到了 Git 来作为云服务器和 GitHub 远程仓库之间的同步工具。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-01.png" alt="" loading="lazy"></p><p>给大家介绍一个牛逼的命令——<code>git sparse-checkout</code>，帮我的云服务器剩下了至少一半的存储空间。</p><h3 id="_1、使用-git-中遇到的一个大麻烦" tabindex="-1"><a class="header-anchor" href="#_1、使用-git-中遇到的一个大麻烦" aria-hidden="true">#</a> 1、使用 Git 中遇到的一个大麻烦</h3>`,42),j={href:"https://tobebetterjavaer.com",target:"_blank",rel:"noopener noreferrer"},_=e("p",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-03.png",alt:"",loading:"lazy"})],-1),y=e("p",null,[i("正所谓"),e("strong",null,"不积跬步无以至千里，不积小流无以成江海"),i("。")],-1),k=e("p",null,"1000 次也许不值一提，但 1000 万也不过是 1 万个 1000，二哥取得的每一点点进步，都要感谢大家的倾力捧场。",-1),$={href:"https://mp.weixin.qq.com/s/NtOD5q95xPEs4aQpu4lGcg",target:"_blank",rel:"noopener noreferrer"},z=e("code",null,"git pull",-1),E={href:"https://mp.weixin.qq.com/s/OYOcjUwPZyPo8K4KAgJ4kw",target:"_blank",rel:"noopener noreferrer"},S=a('<p>直接 <code>git pull</code> 会无脑把 GitHub 上的 codes、images 目录同步到云服务器上，但其实 codes、images 目录是不需要同步的。</p><p>具体是怎么一回事呢？</p><p>大家可以先看一下我这个 GitHub 仓库的目录结构哈。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-04.png" alt="" loading="lazy"></p><ul><li>docs 是文档目录，里面是 md 文件，所有的教程原稿都在这里。</li><li>codes 是代码目录，里面是教程的配套源码。</li><li>images 是图片目录，里面是教程的配套手绘图。</li></ul><p>这样就可以利用 GitHub 来做免费的图床，并且还可以白票 jsDelivr CDN 的全球加速，简直不要太爽！</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-05.png" alt="" loading="lazy"></p><p>比如说 images 目录下有一张 logo 图 logo-01.png：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-06.png" alt="" loading="lazy"></p><p>如果使用 GitHub 仓库的原始路径来访问的话，速度贼慢！</p>',10),H={href:"https://github.com/itwanger/toBeBetterJavaer/tree/master/images/logo-01.png",target:"_blank",rel:"noopener noreferrer"},q=e("p",null,"使用 jsDelivr 加速后就不一样了，速度飞起！",-1),w={href:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/logo-01.png",target:"_blank",rel:"noopener noreferrer"},L=a('<p>简单总结下 GitHub 作为图床的正确用法，就两条：</p><ul><li>创建一个 GitHub 仓库作为图床仓库，上传提交图片到仓库中</li><li>在要使用 GitHub 图床图片的地方将链接换为 <code>https://cdn.jsdelivr.net/gh/{user}/{repo}/图片路径</code></li></ul><p>付费七牛云或者阿里云图床的小伙伴不妨试试这种方式，能白票咱绝不花一分冤枉钱。</p><p>那也就是说，《Java 程序员进阶之路》网站上的图片都是通过 GitHub 图床加载的，不需要将图片从 GitHub 仓库拉取到云服务器上。要知道，一台云服务器的空间是极其昂贵的，能省的空间咱必须得省。</p><h3 id="_2、学习-git-中遇到的一个大惊喜" tabindex="-1"><a class="header-anchor" href="#_2、学习-git-中遇到的一个大惊喜" aria-hidden="true">#</a> 2、学习 Git 中遇到的一个大惊喜</h3><p>于是我今天早上就在琢磨着，怎么样才能把这昂贵的空间省下来呢？</p><p>我百度了很多帖子，绝大多数都乱七八糟，毫无价值，能说到点子上的几乎没有。</p>',7),A={href:"https://mp.weixin.qq.com/s/RpFzXOa2VlFNd7ylLmr9LQ",target:"_blank",rel:"noopener noreferrer"},T=e("strong",null,"git sparse-checkout，它可以帮助我们在拉取远程仓库的时候只同步那些我们想要的目录和文件",-1),D=e("p",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-07.png",alt:"",loading:"lazy"}),i(" 具体怎么用，可以看官方文档：")],-1),M={href:"https://git-scm.com/docs/git-sparse-checkout",target:"_blank",rel:"noopener noreferrer"},B=a('<p>但没必要，hhhh，我们直接实战。</p><p>第一步，通过 <code>git remote add -f orgin git@github.com:itwanger/toBeBetterJavaer.git</code> 命令从 GitHub 上拉取仓库。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-08.png" alt="" loading="lazy"></p><p>第二步，启用 sparse-checkout，并初始化</p><p>拉取到仓库后，执行 <code>git config core.sparseCheckout true</code> 命令启用 sparse-checkout。</p><p>然后再执行 <code>git sparse-checkout init</code> 初始化。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-09.png" alt="" loading="lazy"></p><p>第三步，使用 sparse-checkout 来拉取我们想要的仓库目录</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-10.png" alt="" loading="lazy"></p><p>比如说，我们只想拉取 docs 目录，可以执行 <code>git sparse-checkout set docs</code> 命令。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-11.png" alt="" loading="lazy"></p><p>如果是第一次使用 sparse-checkout 的话，还需要执行一下 <code>git pull orgin master</code> 命令拉取一次。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-12.png" alt="" loading="lazy"> 第四步，验证是否生效</p><p>可以执行 <code>ls -al</code> 命令来确认 sparse-checkout 是否生效。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-13.png" alt="" loading="lazy"></p><p>如图所示，确实只拉取到了 docs 目录。</p><p>假如还想要拉取其他文件或者目录的话，可以通过 <code>git sparse-checkout add</code> 命令来添加。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-14.png" alt="" loading="lazy"></p><p>这就实现了，<strong>远程仓库和云服务器仓库之间的定制化同步，需要什么目录和文件就同步什么目录和文件，不需要的可以统统不要</strong>。</p><p>GitHub 仓库可以免费用，空间也无限大，但云服务可是要抠抠搜搜的用，毕竟扩充存储空间是真的贵！</p><p>我对比了一下，远程仓库大概 145 M，图片就占了 72 M，妥妥地省下了一半的存储空间。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-15.png" alt="" loading="lazy"></p><p>如何禁用 git sparse-checkout 呢？</p><p>也简单，只需要执行一下 <code>git sparse-checkout disable</code> 命令就可以了。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-16.png" alt="" loading="lazy"></p><p>可以看到，那些我们不想要的目录和文件统统都又回来了。</p><p>如果重新启用呢？</p><p>也简单，只需要执行一下 <code>git sparse-checkout reapply</code> 命令就可以了。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-17.png" alt="" loading="lazy"></p><p>简单总结下：如果你要把一个庞大到撑满你硬盘的远程仓库拉取到本地，而你只需要其中的一部分目录和文件，那就可以试一试 <code>git sparse-checkout</code> 了。</p><h3 id="_3、使用-git-后的一点心里话" tabindex="-1"><a class="header-anchor" href="#_3、使用-git-后的一点心里话" aria-hidden="true">#</a> 3、使用 Git 后的一点心里话</h3><p>不得不说，Git 实在是太强大了。就一行命令，解决了困扰我一天的烦恼，我的 80G 存储空间的云服务器又可以再战 3 年了，从此以后再也不用担心了。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/git/sparse-checkout-18.png" alt="" loading="lazy"></p><p>Git 是真的牛逼，Linus 是真的牛逼，神不愧是神！</p><hr><p>推荐阅读：</p>',36),N={href:"https://mp.weixin.qq.com/s/RpFzXOa2VlFNd7ylLmr9LQ",target:"_blank",rel:"noopener noreferrer"},R={href:"https://mp.weixin.qq.com/s/lY79hI7URuFh3gD9DJKInQ",target:"_blank",rel:"noopener noreferrer"},C={href:"https://mp.weixin.qq.com/s/Z766Egape2QicYndsQjZ4g",target:"_blank",rel:"noopener noreferrer"},V=e("p",null,"参考资料：",-1),J={href:"https://zh.wikipedia.org/wiki/Git",target:"_blank",rel:"noopener noreferrer"},O={href:"https://mp.weixin.qq.com/s/gM__sQPILkAKWsMejOO8cA",target:"_blank",rel:"noopener noreferrer"},P=e("hr",null,null,-1),I=e("strong",null,"数据库、计算机网络、算法与数据结构、设计模式、框架类Spring、Netty、微服务（Dubbo，消息队列） 网关",-1),K={href:"https://tobebetterjavaer.com/pdf/programmer-111.html",target:"_blank",rel:"noopener noreferrer"},W=e("p",null,[i("微信搜 "),e("strong",null,"沉默王二"),i(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"111"),i(" 即可免费领取。")],-1),U=e("p",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",loading:"lazy"})],-1);function Q(Y,F){const t=r("ExternalLinkIcon");return d(),l("div",null,[o,e("blockquote",null,[e("p",null,[e("a",v,[i("https://git-scm.com/downloads"),n(t)])])]),m,e("p",null,[i("在 Git 专题的"),e("a",p,[i("开篇"),n(t)]),i("，我就提醒大家一定要记住这几个专用名词，对掌握 Git 有很大的帮助：")]),b,u,g,e("blockquote",null,[e("p",null,[e("a",h,[i("http://www.ruanyifeng.com/blog/2015/12/git-cheat-sheet.html"),n(t)])])]),x,e("blockquote",null,[e("p",null,[e("a",f,[i("https://docs.github.com/cn/authentication/connecting-to-github-with-ssh/about-ssh"),n(t)])])]),G,e("p",null,[i("首先给大家通报一下，一天前"),e("a",j,[i("上线的《Java 程序员进阶之路》网站"),n(t)]),i("，目前访问次数已经突破 1000 了。")]),_,y,k,e("p",null,[i("看过"),e("a",$,[i("上一篇搭建过程"),n(t)]),i("的小伙伴应该都知道了，我是通过在云服务器上 clone 了一份 GitHub 上的远程仓库，然后通过宝塔面板的定时任务执行 "),z,i(" 命令从 GitHub 上拉取到最新的内容，再通过 "),e("a",E,[i("Nginx 服务器"),n(t)]),i("搭建的网站，网站内容是通过 docsify 渲染 md 文件得到的。")]),S,e("blockquote",null,[e("p",null,[e("a",H,[i("https://github.com/itwanger/toBeBetterJavaer/tree/master/images/logo-01.png"),n(t)])])]),q,e("blockquote",null,[e("p",null,[e("a",w,[i("https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/logo-01.png"),n(t)])])]),L,e("p",null,[i("最后还是浏览 Git 官方手册（也可以看"),e("a",A,[i("Pro Git"),n(t)]),i("）才找到了一个牛逼的命令："),T,i("。")]),D,e("blockquote",null,[e("p",null,[e("a",M,[i("https://git-scm.com/docs/git-sparse-checkout"),n(t)])])]),B,e("blockquote",null,[e("ul",null,[e("li",null,[e("a",N,[i("下载→豆瓣9.1分的 Pro Git 学习手册 YYDS！"),n(t)])]),e("li",null,[e("a",R,[i("摸清 Git 的门路，就靠这 22 张图"),n(t)])]),e("li",null,[e("a",C,[i("保姆级Git入门教程，万字详解"),n(t)])])])]),V,e("blockquote",null,[e("ul",null,[e("li",null,[i("维基百科："),e("a",J,[i("https://zh.wikipedia.org/wiki/Git"),n(t)])]),e("li",null,[i("hutusi："),e("a",O,[i("改变世界的一次代码提交"),n(t)])])])]),P,e("p",null,[i("最近整理了一份牛逼的学习资料，包括但不限于Java基础部分（JVM、Java集合框架、多线程），还囊括了 "),I,i(" 等等等等……详情戳："),e("a",K,[i("可以说是2022年全网最全的学习和找工作的PDF资源了"),n(t)])]),W,U])}const ee=s(c,[["render",Q],["__file","git-qiyuan.html.vue"]]);export{ee as default};
