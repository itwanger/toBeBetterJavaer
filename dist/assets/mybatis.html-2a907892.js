...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>BaseMapper里提供的方法如下：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/springboot/mybatis-79ac66eb-25fd-44a0-8668-359d1b95b80d.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><p>第三步，在测试类中添加查询方法。</p><hr>`,14),T={href:"https://tobebetterjavaer.com/zhishixingqiu/",target:"_blank",rel:"noopener noreferrer"},L=e("strong",null,"编程喵",-1),k=e("h3",{id:"源码路径",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#源码路径","aria-hidden":"true"},"#"),n(" 源码路径")],-1),P={href:"https://github.com/itwanger/coding-more",target:"_blank",rel:"noopener noreferrer"},A={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-mybatis",target:"_blank",rel:"noopener noreferrer"},B=e("hr",null,null,-1),E=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function I(U,C){const i=r("ExternalLinkIcon");return l(),d("div",null,[u,v,e("p",null,[e("a",c,[n("Spring Boot 整合 JPA"),s(i)])]),e("p",null,[n("MyBatis 早些时候用起来比较繁琐，需要各种配置文件，需要实体类和 DAO 的映射关联，经过不断地演化和改进，可以通过 "),e("a",p,[n("generator"),s(i)]),n(" 自动生成实体类、配置文件和 DAO 层代码，简化了不少开发工作。")]),e("p",null,[n("随着 "),e("a",m,[n("MyBatis-Plus"),s(i)]),n(" 的出现，又进一步加速了 MyBatis 的发展。经过 MyBatis-Plus 的增强，开发者只需要简单的配置，就可以快速进行单表的 CRUD 操作；同时，MyBatis-Plus又提供了代码生成、自动分页、逻辑删除、自动填充等丰富功能，进一步简化了开发工作。")]),b,e("p",null,[n("MyBatis 属于半自动的 ORM 框架，实现一些简单的 CRUD 也是需要编写 SQL 语句，那如果想省掉这些步骤的话，可以选择 "),e("a",g,[n("JPA"),s(i)]),n("，也可以选择国人开源的 MyBatis-Plus（简称 MP）。")]),h,e("ul",null,[q,_,f,e("li",null,[e("a",x,[n("强大的代码生成器"),s(i)]),n("：可快速生成 Mapper 、 Model 、 Service 、 Controller 层代码")]),y,M]),S,e("p",null,[n("更多内容，只针对《Java程序员进阶之路》星球用户开放，需要的小伙伴可以"),e("a",T,[n("戳链接🔗"),s(i)]),n("加入我们的星球，一起学习，一起卷。。"),L,n("🐱是一个 Spring Boot+Vue 的前后端分离项目，融合了市面上绝大多数流行的技术要点。通过学习实战项目，你可以将所学的知识通过实践进行检验、你可以拓宽自己的技术边界，你可以掌握一个真正的实战项目是如何从 0 到 1 的。")]),k,e("ul",null,[e("li",null,[n("编程喵："),e("a",P,[n("https://github.com/itwanger/coding-more"),s(i)])]),e("li",null,[n("codingmore-mybatis："),e("a",A,[n("https://github.com/itwanger/codingmore-learning"),s(i)])])]),B,E])}const w=a(o,[["render",I],["__file","mybatis.html.vue"]]);export{w as default};
