import{_ as l,W as a,X as t,Y as e,a0 as i,Z as d,a1 as s,C as r}from"./framework-bb7be5cb.js";const c={},v={href:"https://mp.weixin.qq.com/s/3RVsFZ17F0JzoHCLKbQgGw",target:"_blank",rel:"noopener noreferrer"},u=e("strong",null,"560 多名",-1),o={href:"https://mp.weixin.qq.com/s/3RVsFZ17F0JzoHCLKbQgGw",target:"_blank",rel:"noopener noreferrer"},m=s(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>我之前写过两篇关于优化相关文章，发表之后，在全网受到广大网友的好评。阅读量和点赞率都很高，说明了这类文章的价值。</p><p>今天接着优化这个话题，我们一起聊聊Java中代码优化的30个小技巧，希望会对你有所帮助。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-52b1af62-86fe-4c7a-b716-e5e5968c733c.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_1-用string-format拼接字符串" tabindex="-1"><a class="header-anchor" href="#_1-用string-format拼接字符串" aria-hidden="true">#</a> 1.用String.format拼接字符串</h2><p>不知道你有没有拼接过字符串，特别是那种有多个参数，字符串比较长的情况。</p><p>比如现在有个需求：要用get请求调用第三方接口，url后需要拼接多个参数。</p><p>以前我们的请求地址是这样拼接的：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>String url = &quot;http://susan.sc.cn?userName=&quot;+userName+&quot;&amp;age=&quot;+age+&quot;&amp;address=&quot;+address+&quot;&amp;sex=&quot;+sex+&quot;&amp;roledId=&quot;+roleId;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果不做任何处理，当我们请求add接口时，执行结果直接报错：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-478149b7-8982-4b55-accd-2c78c6521dea.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>what？用户能直接看到错误信息？</p><p>这种交互方式给用户的体验非常差，为了解决这个问题，我们通常会在接口中捕获异常：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@GetMapping(&quot;/add&quot;)
public String add() {
    String result = &quot;成功&quot;;
    try {
        int a = 10 / 0;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>返回结果会是true吗？</p><p>答案：是false。</p><p>有些同学可能会反驳，Integer中不是有范围是：<code>-128-127</code>的缓存吗？</p><p>为什么是false？</p><p>先看看Integer的构造方法：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-8128d857-c699-4592-b8af-eec334a0fdcc.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>它其实并没有用到<code>缓存</code>。</p><p>那么缓存是在哪里用的？</p><p>答案在<code>valueOf</code>方法中：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-b332dd5f-e7c1-4c07-8a2b-c5651d4375b0.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>如果上面的判断改成这样：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>String orderStatus1 = new String(&quot;1&quot;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这段代码的关键是PayStrategyFactory类，它是一个策略工厂，里面定义了一个全局的map，在所有IPay的实现类中注册当前实例到map中，然后在调用的地方通过PayStrategyFactory类根据code从map获取支付类实例即可。</p><p>如果加了一个新的支付方式，只需新加一个类实现IPay接口，定义init方法，并且重写pay方法即可，其他代码基本上可以不用动。</p>`,16),h={href:"https://mp.weixin.qq.com/s?__biz=MzkwNjMwMTgzMQ==&mid=2247490272&idx=1&sn=c5db63c7b52e7518b7a42e48c70927fc&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},f=s(`<h2 id="_21-防止死循环" tabindex="-1"><a class="header-anchor" href="#_21-防止死循环" aria-hidden="true">#</a> 21.防止死循环</h2><p>有些小伙伴看到这个标题，可能会感到有点意外，代码中不是应该避免死循环吗？为啥还是会产生死循环？</p><p>殊不知有些死循环是我们自己写的，例如下面这段代码：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>while(true) {
    if(condition) {
        break;
    }
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>不科学呀，为啥还是丢失精度了？</p><p><code>Jdk</code>中<code>BigDecimal</code>的<code>构造方法</code>上有这样一段描述：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-nixgnxmdkddjavadmyhjq-228e98bb-8e62-497f-953e-e831fee0d9e7.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>大致的意思是此构造函数的结果可能不可预测，可能会出现创建时为0.1，但实际是0.1000000000000000055511151231257827021181583404541015625的情况。</p><p>由此可见，使用BigDecimal构造函数初始化对象，也会丢失精度。</p><p>那么，如何才能不丢失精度呢？</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>BigDecimal amount1 = new BigDecimal(Double.toString(0.02));
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>该类的<code>add</code>和<code>remove</code>方法直接抛异常了，因此调用Arrays类的内部ArrayList类的add和remove方法，同样会抛异常。</p><p>说实话，Java代码优化是一个比较大的话题，它里面可以优化的点非常多，我没办法一一列举完。在这里只能抛砖引玉，介绍一下比较常见的知识点，更全面的内容，需要小伙伴们自己去思考和探索。</p><p>这篇文章写了很久，花了很多时间和心思，如果你看了文章有些收获，记得给我点赞鼓励一下喔。</p><hr><p>没有什么使我停留——除了目的，纵然岸旁有玫瑰、有绿荫、有宁静的港湾，我是不系之舟。</p><p><strong>推荐阅读</strong>：</p>`,183),q={href:"https://mp.weixin.qq.com/s/2IUe50xBhuEWKDzARVd51A",target:"_blank",rel:"noopener noreferrer"},S={href:"https://mp.weixin.qq.com/s/3lqp4x1B5LI1hNjWAi6v1g",target:"_blank",rel:"noopener noreferrer"},y={href:"https://mp.weixin.qq.com/s/ZeA-mEyMkEeSHRtd8Pob9A",target:"_blank",rel:"noopener noreferrer"},_={href:"https://mp.weixin.qq.com/s/fNMhpER0tp5RO5TGcgALMQ",target:"_blank",rel:"noopener noreferrer"},L={href:"https://mp.weixin.qq.com/s/IEEkWiI9iN4MEhoHvrTgcg",target:"_blank",rel:"noopener noreferrer"},I={href:"https://mp.weixin.qq.com/s/KxUMq2YmlIBMbAeRwUm8JA",target:"_blank",rel:"noopener noreferrer"},E={href:"https://mp.weixin.qq.com/s/PxgZkuA_SnAgG7xfwlKLgw",target:"_blank",rel:"noopener noreferrer"},w={href:"https://mp.weixin.qq.com/s/R13FkPipfEMKjqNaCL3UoA",target:"_blank",rel:"noopener noreferrer"},A=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-quanxxtjgzysjyyds-33afdc45-d78b-46e0-91c2-1107161496e9.jpg",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),P={href:"https://mp.weixin.qq.com/s/tw4lD0XA67yJKAwIWVicIQ",target:"_blank",rel:"noopener noreferrer"};function C(T,D){const n=r("ExternalLinkIcon");return a(),t("div",null,[e("blockquote",null,[e("p",null,[e("a",v,[i("二哥的编程星球"),d(n)]),i("已经有 "),u,i(" 小伙伴加入了，如果你也需要一个良好的学习氛围，"),e("a",o,[i("戳链接"),d(n)]),i("加入我们吧！这是一个 Java 学习指南 + 编程实战的私密圈子，你可以向二哥提问、帮你制定学习计划、跟着二哥一起做项目、刷力扣，冲冲冲。")])]),m,e("p",null,[i("如果你了解更多非常有用的第三方工具类的话，可以看看我的另一篇文章《"),e("a",p,[i("吐血推荐17个提升开发效率的“轮子”"),d(n)]),i("》。")]),b,e("p",null,[i("关于大事务问题我的另一篇文章《"),e("a",g,[i("让人头痛的大事务问题到底要如何解决？"),d(n)]),i("》，它里面做了非常详细的介绍，如果大家感兴趣可以看看。")]),x,e("p",null,[i("当然，消除又臭又长的if...else判断，还有很多方法，比如：使用注解、动态拼接类名称、模板方法、枚举等等。由于篇幅有限，在这里我就不过多介绍了，更详细的内容可以看看我的另一篇文章《"),e("a",h,[i("消除if...else是9条锦囊妙计"),d(n)]),i("》")]),f,e("ul",null,[e("li",null,[e("a",q,[i("新一代开源免费的终端工具，太酷了"),d(n)])]),e("li",null,[e("a",S,[i("最大成就，拿到一等奖学金"),d(n)])]),e("li",null,[e("a",y,[i("银行开发太安逸，奋发图强要跳槽"),d(n)])]),e("li",null,[e("a",_,[i("这个大专生，强的离谱！"),d(n)])]),e("li",null,[e("a",L,[i("一怒之下，退伍转码"),d(n)])]),e("li",null,[e("a",I,[i("没必要为实习碰的头破血流"),d(n)])]),e("li",null,[e("a",E,[i("网站挣了 200 美刀后的感触"),d(n)])]),e("li",null,[e("a",w,[i("在 IDEA 里下五子棋不过分吧？"),d(n)])])]),A,e("blockquote",null,[e("p",null,[i("转载链接："),e("a",P,[i("https://mp.weixin.qq.com/s/tw4lD0XA67yJKAwIWVicIQ"),d(n)]),i("，出处：macrozheng，整理：沉默王二")])])])}const U=l(c,[["render",C],["__file","nixgnxmdkddjavadmyhjq.html.vue"]]);export{U as default};
