...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>幂等性是开发当中很常见也很重要的一个需求，尤其是支付、订单等与金钱挂钩的服务，保证接口幂等性尤其重要。在实际开发中，我们需要针对不同的业务场景我们需要灵活的选择幂等性的实现方式：</p><ul><li>对于下单等存在唯一主键的，可以使用“唯一主键方案”的方式实现。对于更新订单状态等相关的更新场景操作，使用“乐观锁方案”实现更为简单。</li><li>对于上下游这种，下游请求上游，上游服务可以使用“下游传递唯一序列号方案”更为合理。</li><li>类似于前端重复提交、重复下单、没有唯一ID号的场景，可以通过 Token 与 Redis 配合的“防重 Token 方案”实现更为快捷。</li></ul><p>上面只是给与一些建议，再次强调一下，实现幂等性需要先理解自身业务需求，根据业务逻辑来实现这样才合理，处理好其中的每一个结点细节，完善整体的业务流程设计，才能更好的保证系统的正常运行。最后做一个简单总结，然后本博文到此结束，如下：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-xiapemrhbzjkdmdx-8ae66a95-6a7a-4f32-9e01-8fa08b48626c.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><hr><p>没有什么使我停留——除了目的，纵然岸旁有玫瑰、有绿荫、有宁静的港湾，我是不系之舟。</p><p><strong>推荐阅读</strong>：</p>`,107),o={href:"https://mp.weixin.qq.com/s/2IUe50xBhuEWKDzARVd51A",target:"_blank",rel:"noopener noreferrer"},h={href:"https://mp.weixin.qq.com/s/3lqp4x1B5LI1hNjWAi6v1g",target:"_blank",rel:"noopener noreferrer"},p={href:"https://mp.weixin.qq.com/s/ZeA-mEyMkEeSHRtd8Pob9A",target:"_blank",rel:"noopener noreferrer"},g={href:"https://mp.weixin.qq.com/s/fNMhpER0tp5RO5TGcgALMQ",target:"_blank",rel:"noopener noreferrer"},f={href:"https://mp.weixin.qq.com/s/IEEkWiI9iN4MEhoHvrTgcg",target:"_blank",rel:"noopener noreferrer"},k={href:"https://mp.weixin.qq.com/s/KxUMq2YmlIBMbAeRwUm8JA",target:"_blank",rel:"noopener noreferrer"},x={href:"https://mp.weixin.qq.com/s/PxgZkuA_SnAgG7xfwlKLgw",target:"_blank",rel:"noopener noreferrer"},q={href:"https://mp.weixin.qq.com/s/R13FkPipfEMKjqNaCL3UoA",target:"_blank",rel:"noopener noreferrer"},T=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-quanxxtjgzysjyyds-33afdc45-d78b-46e0-91c2-1107161496e9.jpg",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),_={href:"https://mp.weixin.qq.com/s/tL0fnUR3BNBjP8Qw2pldVg",target:"_blank",rel:"noopener noreferrer"};function I(R,y){const n=s("ExternalLinkIcon");return a(),r("div",null,[e("blockquote",null,[e("p",null,[e("a",c,[i("二哥的编程星球"),d(n)]),i("已经有 "),u,i(" 小伙伴加入了，如果你也需要一个良好的学习氛围，"),e("a",b,[i("戳链接"),d(n)]),i("加入我们吧！这是一个 Java 学习指南 + 编程实战的私密圈子，你可以向二哥提问、帮你制定学习计划、跟着二哥一起做项目、刷力扣，冲冲冲。")])]),m,e("ul",null,[e("li",null,[e("a",o,[i("新一代开源免费的终端工具，太酷了"),d(n)])]),e("li",null,[e("a",h,[i("最大成就，拿到一等奖学金"),d(n)])]),e("li",null,[e("a",p,[i("银行开发太安逸，奋发图强要跳槽"),d(n)])]),e("li",null,[e("a",g,[i("这个大专生，强的离谱！"),d(n)])]),e("li",null,[e("a",f,[i("一怒之下，退伍转码"),d(n)])]),e("li",null,[e("a",k,[i("没必要为实习碰的头破血流"),d(n)])]),e("li",null,[e("a",x,[i("网站挣了 200 美刀后的感触"),d(n)])]),e("li",null,[e("a",q,[i("在 IDEA 里下五子棋不过分吧？"),d(n)])])]),T,e("blockquote",null,[e("p",null,[i("转载链接："),e("a",_,[i("https://mp.weixin.qq.com/s/tL0fnUR3BNBjP8Qw2pldVg"),d(n)]),i("，出处：JavaGuide，整理：沉默王二")])])])}const E=l(t,[["render",I],["__file","xiapemrhbzjkdmdx.html.vue"]]);export{E as default};
