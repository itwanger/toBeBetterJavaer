import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as t,a as e,d as i,b as s,e as d,r}from"./app.53992e11.js";const u={},c=d(`<p>当你加入一家电商公司的话，很有可能会被问到“红包雨🧧如何设计和实现”这个问题，今天就来和球友们聊一聊。</p><p>所谓的红包雨，就是指在某次活动中，红包会以<strong>雨滴</strong>的形式落下，用户点击屏幕上落下的红包，若抢到红包，红包会以现金的形式进入用户账户。</p><p>红包雨是一个典型的高并发场景，短时间内有海量请求访问服务端，为了让系统运行顺畅，抢红包一般会采用基于 <strong>Redis + Lua 脚本</strong>的设计方案。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-c1fd7dd9-3974-41e8-a22c-4a4d25f80e73.jpg" alt="" loading="lazy"></p><h2 id="_1-整体流程" tabindex="-1"><a class="header-anchor" href="#_1-整体流程" aria-hidden="true">#</a> 1 整体流程</h2><p>我们来分析下抢红包的整体流程 ：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-47986b38-a727-4894-935c-3675811c5069.jpg" alt="" loading="lazy"></p><ol><li>运营系统配置红包雨活动总金额以及红包个数，提前计算出各个红包的金额并存储到 Redis 中；</li><li>抢红包雨界面，用户点击屏幕上落下的红包，发起抢红包请求；</li><li>TCP 网关接收抢红包请求后，调用抢红包的 dubbo 服务，抢红包服务本质上就是执行 Lua 脚本，将结果通过 TCP 网关返回给前端；</li><li>用户若抢到红包，异步任务会从 Redis 中 获取抢得的红包信息，调用余额系统，将金额返回到用户账户。</li></ol><h2 id="_2-红包-redis-设计" tabindex="-1"><a class="header-anchor" href="#_2-红包-redis-设计" aria-hidden="true">#</a> 2 红包 Redis 设计</h2><p>抢红包有如下规则：</p><ul><li>同一活动，用户只能抢红包一次 ；</li><li>红包数量有限，一个红包只能被一个用户抢到。</li></ul><p>如下图，我们设计三种数据类型：</p><ol><li>运营预分配红包列表 ;</li></ol><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-24dd06eb-b6ba-4123-a4da-d546a4415528.jpg" alt="" loading="lazy"></p><p>队列元素 json 数据格式 ：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{
    //红包编号
    redPacketId : &#39;365628617880842241&#39; 
    //红包金额
    amount : &#39;12.21&#39;          
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>用户红包领取记录列表；</li></ol><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-shizlllldsjtzhbygndsjysx-ef69cad5-d918-40f8-a098-1f1155e1b50e.jpg" alt="" loading="lazy"></p><p>队列元素 json 数据格式：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>{
    //红包编号
    redPacketId : &#39;365628617880842241&#39;
    //红包金额
    amount : &#39;12.21&#39;,
