import{_ as s,W as l,X as t,Y as e,a0 as n,Z as a,a1 as d,C as r}from"./framework-bb7be5cb.js";const u={},v=e("p",null,"俗话说了，“金无足赤人无完人”，HashMap 也不例外，有一种需求它就满足不了，假如我们需要一个按照插入顺序来排列的键值对集合，那 HashMap 就无能为力了。那该怎么办呢？必须得上今天这篇文章的主角：LinkedHashMap。",-1),o={href:"https://tobebetterjavaer.com/collection/hashmap.html",target:"_blank",rel:"noopener noreferrer"},c=e("p",null,"为了提高查找效率，HashMap 在插入的时候对键做了一次哈希算法，这就导致插入的元素是无序的。",-1),p={href:"https://tobebetterjavaer.com/collection/hashmap.html",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"put()",-1),b=d(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>final V putVal(int hash, K key, V value, boolean onlyIfAbsent,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>removeEldestEntry()</code> 方法会判断第一个元素是否超出了可容纳的最大范围，如果超出，那就会调用 <code>removeNode()</code> 方法对最不经常访问的那个元素进行删除。</p><h2 id="_03、最后" tabindex="-1"><a class="header-anchor" href="#_03、最后" aria-hidden="true">#</a> 03、最后</h2><p>由于 LinkedHashMap 要维护双向链表，所以 LinkedHashMap 在插入、删除操作的时候，花费的时间要比 HashMap 多一些。</p><p>这也是没办法的事，对吧，欲戴皇冠必承其重嘛。既然想要维护元素的顺序，总要付出点代价才行。</p><hr>`,33),H=e("strong",null,"数据库、计算机网络、算法与数据结构、设计模式、框架类Spring、Netty、微服务（Dubbo，消息队列） 网关",-1),f={href:"https://tobebetterjavaer.com/pdf/programmer-111.html",target:"_blank",rel:"noopener noreferrer"},y=e("p",null,[n("微信搜 "),e("strong",null,"沉默王二"),n(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"111"),n(" 即可免费领取。")],-1),_=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function L(N,V){const i=r("ExternalLinkIcon");return l(),t("div",null,[v,e("p",null,[n("同学们好啊，还记得 "),e("a",o,[n("HashMap"),a(i)]),n(" 那篇吗？我自己感觉写得非常棒啊，既通俗易懂，又深入源码，真的是分析得透透彻彻、清清楚楚、明明白白的。（一不小心又甩了三个成语，有文化吧？）HashMap 哪哪都好，真的，只要你想用键值对，第一时间就应该想到它。")]),c,e("p",null,[n("对这一点还不太明白的同学，可以再回到 "),e("a",p,[n("HashMap"),a(i)]),n(" 那一篇，看看我对 "),m,n(" 方法的讲解。")]),b,e("p",null,[n("关于双向链表，同学们可以回头看一遍我写的 "),e("a",h,[n("LinkedList"),a(i)]),n(" 那篇文章，会对理解本篇的 LinkedHashMap 有很大的帮助。")]),g,e("p",null,[n("在 "),e("a",q,[n("HashMap"),a(i)]),n(" 那篇文章里，我有讲解到一点，不知道同学们记不记得，就是 null 会插入到 HashMap 的第一位。")]),M,e("p",null,[n("第一个参数和第二个参数，看过 "),e("a",k,[n("HashMap"),a(i)]),n(" 的同学们应该很熟悉了，指的是初始容量和负载因子。")]),x,e("p",null,[n("最近整理了一份牛逼的学习资料，包括但不限于Java基础部分（JVM、Java集合框架、多线程），还囊括了 "),H,n(" 等等等等……详情戳："),e("a",f,[n("可以说是2022年全网最全的学习和找工作的PDF资源了"),a(i)])]),y,_])}const E=s(u,[["render",L],["__file","linkedhashmap.html.vue"]]);export{E as default};
