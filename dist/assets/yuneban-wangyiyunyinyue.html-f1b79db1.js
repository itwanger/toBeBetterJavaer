import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as r,c as s,a as e,d as l,b as o,e as i}from"./app-72970f25.js";const c={},d=i(`<h1 id="云音乐" tabindex="-1"><a class="header-anchor" href="#云音乐" aria-hidden="true">#</a> 云音乐</h1><p>大家好，我是二哥呀！</p><p>前段时间，有个读者私信我说，<strong>刚学完 Spring Boot，想找点练手项目，准备找实习了。</strong></p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/kaiyuan/yuneban-wangyiyunyinyue-01.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>二哥这么贴心，对于读者的请求，一向是有求必应，有问必答。那自然得花心思去淘 2 个像样的 Java 练手项目出来了，关键是还要基础，不能太难😆。</p><p>我之前有给大家推荐过 GitHub 上的 vhr、mall 和 miaosha，那这次想换个思路，到 B 站上淘一淘如何呢？</p><p>果真，还真让二哥找到了！小破站，YYDS！</p><h3 id="一、云-e-办" tabindex="-1"><a class="header-anchor" href="#一、云-e-办" aria-hidden="true">#</a> 一、云 E 办</h3><p>这是一个带大家从 0 搭建一个 Spring Boot+ Vue 的前后端分离的 Java 项目，前 P71 讲前端，P72 到 P131 讲后端。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/kaiyuan/yuneban-wangyiyunyinyue-02.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>前端涉及到的技术有 Vue 全家桶、ElementUI；后端涉及到的技术有 Spring Boot、SpringMVC、MyBatisPlus、SpringSecurity、Swagger、Redis、EasyPOI、RabbitMQ、FasfDFS 等等。</p><p>视频整体上是不错的，up 的声音也很清晰，听起来很舒服。</p><p>为了验证 up 是不是一家培训机构，顺带替大家踩踩坑。我按照要求加了小助理的微信：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/kaiyuan/yuneban-wangyiyunyinyue-03.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>加好友时一看头像，和平常偷偷摸摸混进群的广告党差不多，哈哈哈。</p><p>通过好友后，再去一查「乐字节」这个关键字，果然是一家培训机构，不过视频既然公开了出来，并且质量也说得过去，那果断学习一波也是很舒服的。</p><p>有时候，培训机构公开出来的视频课可能要好过付费小几万的付费视频课，毕竟拿出来的东西不能太水，否则会砸了自己招牌。</p><p>况且，二哥深入虎穴这一波也替大家踩过坑了，源码和课件都拿到了，直接在公众号后台回复关键字「<strong>B站</strong>」就可以拉取到了，不用再去加小助理微信了，大家可以放心食用。</p><p>怎么样，二哥这波安全拦截做得漂亮吧？</p><h3 id="二、仿网易云音乐的小网站" tabindex="-1"><a class="header-anchor" href="#二、仿网易云音乐的小网站" aria-hidden="true">#</a> 二、仿网易云音乐的小网站</h3><p>这是读者提供的一个前后端分离项目，问我项目怎么样，我点开去一看，这不一个号主朋友的嘛。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/kaiyuan/yuneban-wangyiyunyinyue-04.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>网站的客户端和管理端使用 VUE 框架来实现的，服务端使用 Spring Boot + MyBatis 来实现，数据库使用了 MySQL。建议至少 1.5 倍速食用。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/kaiyuan/yuneban-wangyiyunyinyue-05.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>前后端整体的项目结构也挺清晰的，这是后端的。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── avatorImages // 用户头像
├── img
│   ├── singerPic // 歌手图片
│   ├── songListPic // 歌单图片
│   └── songPic // 歌曲图片
