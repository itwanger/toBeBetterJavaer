import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as d,c as r,a as e,d as n,b as s,e as c}from"./app-1c5b5ce3.js";const t={},v=c(`<p>最近，我们的线上环境出现了一个问题，线上代码在执行过程中抛出了一个IllegalArgumentException，分析堆栈后，发现最根本的的异常是以下内容：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>java.lang.IllegalArgumentException: 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于像阿里这种比较庞大的互联网公司，<strong>随便提供出去的一个接口，可能有上百个调用方</strong>，而接口升级也是常态，<strong>我们根本做不到每次二方库升级之后要求所有调用者跟着一起升级</strong>，这是完全不现实的，并且对于有些调用者来说，他用不到新特性，完全没必要做升级。</p><p>还有一种看起来比较特殊，但是实际上比较常见的情况，就是有的时候一个接口的声明在A包中，而一些枚举常量定义在B包中，比较常见的就是阿里的交易相关的信息，订单分很多层次，每次引入一个包的同时都需要引入几十个包。</p><p>对于调用者来说，我肯定是不希望我的系统引入太多的依赖的，<strong>一方面依赖多了会导致应用的编译过程很慢，并且很容易出现依赖冲突问题。</strong></p><p>所以，在调用下游接口的时候，如果参数中字段的类型是枚举的话，那我没办法，必须得依赖他的二方库。但是如果不是枚举，只是一个字符串，那我就可以选择不依赖。</p><p>所以，我们在定义接口的时候，会尽量避免使用枚举这种强类型。规范中规定在返回值中不允许使用，而我自己要求更高，就是即使在接口的入参中我也很少使用。</p><p>最后，我只是不建议在对外提供的接口的出入参中使用枚举，并不是说彻底不要用枚举，我之前很多文章也提到过，枚举有很多好处，我在代码中也经常使用。所以，切不可因噎废食。</p><p>当然，文中的观点仅代表我个人，具体是是不是适用其他人，其他场景或者其他公司的实践，需要读者们自行分辨下，建议大家在使用的时候可以多思考一下。</p><hr><p><strong>微信8.0将好友放开到了一万，小伙伴可以加我大号了，先到先得，再满就真没了</strong></p><p><strong>扫描下方二维码即可加我微信啦，<code>2022，抱团取暖，一起牛逼。</code></strong></p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-xinlgjszjszzdwjkzsymjlxyhjbyll-11f8353c-3795-4e07-9d96-4c26d9574aa5.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="推荐阅读" tabindex="-1"><a class="header-anchor" href="#推荐阅读" aria-hidden="true">#</a> 推荐阅读</h2>`,57),u={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+584&idx=1&sn=14ab8fa74ed8391a5cb91449f699123a&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},o={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+513&idx=1&sn=5b6cb49477f411bcde02b8601e50968b&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},p={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+482&idx=1&sn=713a30c88cea125f4768e6a0df939600&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},b={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+148&idx=1&sn=e49cb3da841bf35c331f9e378d8cffdd&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},m={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+84&idx=1&sn=5bd4e684af3cfede8f332c423a478abf&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},g={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+55&idx=1&sn=3faa578dd23b296cdb4dbd19910d2a46&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},h={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2247499376&idx=1&sn=3ed28795cdd35fbaa3506e74a56703b0&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},_={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2247486684&idx=1&sn=807fd808adac8019eb2095ba088efe54&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},f=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-xinlgjszjszzdwjkzsymjlxyhjbyll-938d5f07-9996-4215-abe6-4d029c00414e.jpg",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),x={href:"https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+626&idx=1&sn=149f436a3c80414c949ad4ad9a7ebb77&chksm=fc2c7f5acb5bf64cee6ddf2e13ec9cfa2f0bdad617708226e72619c9f955ef82d81030a5fbc5#rd",target:"_blank",rel:"noopener noreferrer"};function z(y,A){const i=l("ExternalLinkIcon");return d(),r("div",null,[v,e("ul",null,[e("li",null,[e("a",u,[n("阿里出品！SpringBoot应用自动化部署神器，IDEA版Jenkins？"),s(i)])]),e("li",null,[e("a",o,[n("不要再重复造轮子了！这17个Java常用工具类，让生产力爆表！"),s(i)])]),e("li",null,[e("a",p,[n("再见命令行！一键部署应用到远程服务器，IDEA官方Docker插件真香！"),s(i)])]),e("li",null,[e("a",b,[n("再见收费的Navicat！这款开源的数据库管理工具界面更炫酷！"),s(i)])]),e("li",null,[e("a",m,[n("还在从零开始搭建项目？这款升级版快速开发脚手架值得一试！"),s(i)])]),e("li",null,[e("a",g,[n("别再用过时的方式了！全新版本Spring Security，这样用才够优雅！"),s(i)])]),e("li",null,[e("a",h,[n("重磅更新！Mall实战教程全面升级，瞬间高大上了！"),s(i)])]),e("li",null,[e("a",_,[n("40K+Star！Mall电商实战项目开源回忆录！"),s(i)])])]),f,e("blockquote",null,[e("p",null,[n("转载链接："),e("a",x,[n("https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2248700+626&idx=1&sn=149f436a3c80414c949ad4ad9a7ebb77&chksm=fc2c7f5acb5bf64cee6ddf2e13ec9cfa2f0bdad617708226e72619c9f955ef82d81030a5fbc5#rd"),s(i)]),n("，出处：macrozheng，整理：沉默王二")])])])}const q=a(t,[["render",z],["__file","xinlgjszjszzdwjkzsymjlxyhjbyll.html.vue"]]);export{q as default};
