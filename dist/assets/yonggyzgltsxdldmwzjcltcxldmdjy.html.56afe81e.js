import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as d,c as r,a as e,d as n,b as s,e as l,r as t}from"./app.53992e11.js";const c={},o={href:"https://mp.weixin.qq.com/s/CljCSezUgoBXb-T9wbIGww",target:"_blank",rel:"noopener noreferrer"},v=e("strong",null,"1100 多名",-1),u={href:"https://mp.weixin.qq.com/s/hXXBTPPkFj2VMg_GXqn4EA",target:"_blank",rel:"noopener noreferrer"},m=l(`<p>毕业五年多，一共待过3家公司，碰到各种各样的同事，见识过各种各样的代码，有优雅的，赏心悦目的，也有垃圾的，屎山一样的。因此，写这篇文章，来记录一下一个优秀的后端开发程序员，应该有哪些好的开发习惯。</p><h2 id="_1-注释尽可能全面-写有意义的注释" tabindex="-1"><a class="header-anchor" href="#_1-注释尽可能全面-写有意义的注释" aria-hidden="true">#</a> 1.注释尽可能全面,写有意义的注释</h2><p>接口方法、类、复杂的业务逻辑，都应该添加有意义的注释</p><ul><li>对于接口方法的注释，应该包含详细的入参和结果说明，有异常抛出的情况也要详细叙述</li><li>类的注释应该包含类的功能说明、作者和修改者。</li><li>如果是业务逻辑很复杂的代码，真的非常有必要写清楚注释。</li></ul><p>清楚的注释，更有利于后面的维护。</p><p><img src="https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwzUcJibAJ2ibvG9KRfycQHj2xQuEehJqaQ04XeXQE3U2jiceLlRMhyWiczr7AfAJoTHFzUtbFT4dTrXQ/640?wx_fmt=png&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="" loading="lazy"></p><h2 id="_2-项目拆分合理的目录结构" tabindex="-1"><a class="header-anchor" href="#_2-项目拆分合理的目录结构" aria-hidden="true">#</a> 2.项目拆分合理的目录结构</h2><p>记得读大学那会，刚学做各种各样的管理系统，都是用<code>MVC</code>模式，也就是<code>controller、service、mapper、entity</code>。如果未来业务扩展，你没有拆分业务结构的话，很可能就会发现，一个<code>service</code>包下，有上百个服务。。。</p><p>正确的做法，如果服务过多，应该根据不同的业务进行划分，比如订单、登陆、积分等等</p><p><img src="https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwzUcJibAJ2ibvG9KRfycQHj2maPuWGb0oyYkuAUXcCOZsqINjIibtk3c250VBTVP2bDibkk0UWLaLvdA/640?wx_fmt=png&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="" loading="lazy"></p><p>当然，你也可以根据不同的业务划分模块，比如建一个<code>moudles</code>包，然后按订单、登陆等业务划分，每个业务都有自己的<code>controller、service、mapper、entity</code>。</p><p>我们拆分的目的，就是<strong>让项目结构更清晰，可读性更强，更容易维护</strong>而已。</p><h2 id="_3-不在循环里远程调用、或者数据库操作-优先考虑批量进行。" tabindex="-1"><a class="header-anchor" href="#_3-不在循环里远程调用、或者数据库操作-优先考虑批量进行。" aria-hidden="true">#</a> 3. 不在循环里远程调用、或者数据库操作，优先考虑批量进行。</h2><p>远程操作或者数据库操作都是<strong>比较耗网络、IO资源</strong>的，所以尽量不在循环里远程调用、不在循环里操作数据库，能<strong>批量一次性查回来尽量不要循环多次去查</strong>。（但是呢，如果是操作数据库，也不要一次性查太多数据哈，可以分批500一次酱紫）。</p><p>正例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>remoteBatchQuery(param);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwzUcJibAJ2ibvG9KRfycQHj27BO7ibP20KCp8uFLneGYLfUnwUa4WHlOedpSahVEV18klFyHBBShHlQ/640?wx_fmt=png&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="" loading="lazy"></p><h2 id="_4-封装方法形参" tabindex="-1"><a class="header-anchor" href="#_4-封装方法形参" aria-hidden="true">#</a> 4. 封装方法形参</h2><p>如果你的方法参数过多，要封装一个对象出来。反例如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public void getUserInfo（String name,String age,String sex,String mobile,String idNo){
  // do something ...
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-封装通用模板" tabindex="-1"><a class="header-anchor" href="#_5-封装通用模板" aria-hidden="true">#</a> 5. 封装通用模板</h2><p>一个优秀的后端开发，应该具备<strong>封装通用模板</strong>的编码能力。</p><p>我们来看一个业务需求：假设我们有这么一个业务场景：内部系统不同商户，调用我们系统接口，去跟外部第三方系统交互（http方式）。走类似这么一个流程，如下：</p><p><img src="https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwzUcJibAJ2ibvG9KRfycQHj23ECiagicec6ASWicalZYD8ox6AzLaLvgPm8FicmjWq1f2WzUWmb3szXgRw/640?wx_fmt=png&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="" loading="lazy"></p><p>一个请求都会经历这几个流程：</p><ul><li>查询商户信息</li><li>对请求报文加签</li><li>发送http请求出去</li><li>对返回的报文验签</li></ul><p>通过HTTP发请求出去时，有的商户可能是<strong>走代理</strong>的，有的是走直连。假设当前有A，B商户接入，不少伙伴可能这么实现，伪代码如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 商户A处理句柄
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-保持优化性能的嗅觉" tabindex="-1"><a class="header-anchor" href="#_7-保持优化性能的嗅觉" aria-hidden="true">#</a> 7. 保持优化性能的嗅觉</h2><p>优秀的后端开发，应该保持优化性能的嗅觉。比如<code>避免创建比必要的对象、异步处理、使用缓冲流，减少IO操作</code>等等。</p><p>比如，我们设计一个<code>APP</code>首页的接口，它需要<code>查用户信息、需要查banner信息、需要查弹窗信息</code>等等。假设耗时如下：</p><p><img src="https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwzUcJibAJ2ibvG9KRfycQHj29EIA1ScuN7qgQqTbVdqZR6YpDQrTXHnbNVsibmShp0SqfGSFZadLXRA/640?wx_fmt=png&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="" loading="lazy"></p><p>查用户信息<code>200</code>ms，查banner信息<code>100</code>ms、查弹窗信息<code>50</code>ms，那一共就耗时<code>350</code>ms了。如果还查其他信息，那耗时就更大了。如何优化它呢？可以并行发起，耗时可以降为<code>200</code>ms。如下：</p><p><img src="https://mmbiz.qpic.cn/mmbiz_png/PoF8jo1PmpwzUcJibAJ2ibvG9KRfycQHj2AibYhWBc4nV60xuicPQmMfIuvejZq798Z7Ckgvj1VDhkicRa4FR1Xibia9w/640?wx_fmt=png&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="" loading="lazy"></p>`,47),b={href:"https://mp.weixin.qq.com/s?__biz=Mzg3NzU5NTIwNg==&mid=2247499504&idx=1&sn=bb62226e6cffeb1859efb0100c796050&chksm=cf2221d9f855a8cf23f75cb51c1a407578fb0f279e96ddae74b5b8c84f2f5dc71762425b17cb&token=1305910004&lang=zh_CN&scene=21#wechat_redirect",target:"_blank",rel:"noopener noreferrer"},p=l(`<h2 id="_8-可变参数的配置化处理" tabindex="-1"><a class="header-anchor" href="#_8-可变参数的配置化处理" aria-hidden="true">#</a> 8. 可变参数的配置化处理</h2><p>日常开发中，我们经常会遇到一些可变参数，比如<code>用户多少天没登录注销</code>、<code>运营活动，不同节日红包皮肤切换、订单多久没付款就删除</code>等等。对于这些可变的参数，不用该直接写死在代码。优秀的后端，要做配置化处理，你可以把这些可变参数，放到数据库一个配置表里面，也可以放到项目的配置文件或者<code>apollo</code>上。</p><p>比如产品经理提了个红包需求，圣诞节的时候，红包皮肤为圣诞节相关的，春节的时候，为春节红包皮肤等。如果在代码写死控制，可有类似以下代码：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>if(duringChristmas){
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p>没有什么使我停留——除了目的，纵然岸旁有玫瑰、有绿荫、有宁静的港湾，我是不系之舟🤔。</p>`,16),x={href:"https://mp.weixin.qq.com/s/q-o4SBZQ3SH62T0c52aBUw",target:"_blank",rel:"noopener noreferrer"},f={href:"https://mp.weixin.qq.com/s/4Zcd16hMazydelrN6CUXBA",target:"_blank",rel:"noopener noreferrer"},_={href:"https://mp.weixin.qq.com/s/LKkvcSdhMyXAGgtqEak0Zw",target:"_blank",rel:"noopener noreferrer"},q={href:"https://mp.weixin.qq.com/s/mrSxrQYaWiUE82tBUu3XIw",target:"_blank",rel:"noopener noreferrer"},w={href:"https://mp.weixin.qq.com/s/eyCEQKclRkTnsJze01Bilg",target:"_blank",rel:"noopener noreferrer"},y={href:"https://mp.weixin.qq.com/s/Dv_kcwUT-KTZ6LAwn3o_Jg",target:"_blank",rel:"noopener noreferrer"},S={href:"https://mp.weixin.qq.com/s/yYWD0VPZ_NoGPOmhoa-OlQ",target:"_blank",rel:"noopener noreferrer"},z={href:"https://mp.weixin.qq.com/s/OHXpEOKcLaKW8h0TS4Xqjg",target:"_blank",rel:"noopener noreferrer"},A={href:"https://mp.weixin.qq.com/s/6YuyA1Ja5RfDEQatfsQpjA",target:"_blank",rel:"noopener noreferrer"},k={href:"https://mp.weixin.qq.com/s/EW95wdK4SM0CiBEJqUP7Mg",target:"_blank",rel:"noopener noreferrer"},E={href:"https://mp.weixin.qq.com/s/PmVwFKsXkGeJjmNPiu5hrQ",target:"_blank",rel:"noopener noreferrer"},T=e("p",null,[e("img",{src:"https://files.mdnice.com/user/3903/b7e50cf4-6fca-4511-9bfd-aa1ed9eb587b.png",alt:"",loading:"lazy"})],-1);function U(P,O){const i=t("ExternalLinkIcon");return d(),r("div",null,[e("blockquote",null,[e("p",null,[e("a",o,[n("二哥的编程星球"),s(i)]),n("已经有 "),v,n(" 球友加入了，如果你也需要一个良好的学习氛围，"),e("a",u,[n("戳链接"),s(i)]),n("加入我们吧！这是一个编程学习指南+ Java项目实战+LeetCode 刷题的私密圈子，你可以阅读星球专栏、向二哥提问、帮你制定学习计划、和球友一起打卡成长，冲冲冲。")])]),m,e("p",null,[n("之前我写过一篇后端思维的文章，手把手教大家如何抽并行调用框架，大家可以看下："),e("a",b,[n("后端思维篇：手把手教你写一个并行调用模板"),s(i)])]),p,e("p",null,[n("之前写过一篇打印日志的15个建议，大家可以看看哈：   "),e("a",g,[n("别再乱打日志了，这份 Java 日志规范，应有尽有，建议收藏！！"),s(i)])]),h,e("ul",null,[e("li",null,[n("✌️："),e("a",x,[n("工作四年，被动醒悟"),s(i)])]),e("li",null,[n("✌️："),e("a",f,[n("来网易四个月，真的不一样"),s(i)])]),e("li",null,[n("✌️："),e("a",_,[n("秋招 13 家 offer，手到擒来"),s(i)])]),e("li",null,[n("✌️："),e("a",q,[n("考研失败，真的不甘心"),s(i)])]),e("li",null,[n("✌️："),e("a",w,[n("想春招找个实习，我该如何准备？"),s(i)])]),e("li",null,[n("✌️："),e("a",y,[n("逼签！冲字节还是苟同花顺？"),s(i)])]),e("li",null,[n("✌️："),e("a",S,[n("简历上写了这俩项目，超级加分！"),s(i)])]),e("li",null,[n("✌️："),e("a",z,[n("双非很菜，拿到这俩offer挺不容易"),s(i)])]),e("li",null,[n("✌️："),e("a",A,[n("今年嵌入式软件这块真挺香"),s(i)])]),e("li",null,[n("✌️："),e("a",k,[n("入职 15 天，就想跑路了？"),s(i)])]),e("li",null,[n("✌️："),e("a",E,[n("比亚迪，救了我秋招的命"),s(i)])])]),T])}const j=a(c,[["render",U],["__file","yonggyzgltsxdldmwzjcltcxldmdjy.html.vue"]]);export{j as default};
