...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>类型为 Utf8，UTF-8 编码的字符串，值为 <code>I</code>，表明字段的类型为 int。</p><p>关于字段类型的描述符映射表如下图所示。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/bytecode-cbf16ce9-7853-4050-a1c0-8b874f3b0c1e.png" alt="" loading="lazy"></p><p>到此为止，第 2 个常量算是摸完了。组合起来的意思就是，声明了一个类型为 int 的字段 age。</p><hr><h3 id="_04、字段表集合" tabindex="-1"><a class="header-anchor" href="#_04、字段表集合" aria-hidden="true">#</a> 04、字段表集合</h3><p>字段表用来描述接口或者类中声明的变量，包括类变量和成员变量，但不包含声明在方法中局部变量。</p><p>字段的修饰符一般有：</p><ul><li>访问权限修饰符，比如 public private protected</li><li>静态变量修饰符，比如 static</li><li>final 修饰符</li><li>并发可见性修饰符，比如 volatile</li><li>序列化修饰符，比如 transient</li></ul><p>然后是字段的类型（可以是基本数据类型、数组和对象）和名称。</p><p>在 Main.class 字节码文件中，字段表的信息如下所示。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>private int age;
    descriptor: I
    flags: (0x0002) ACC_PRIVATE
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>表明字段的访问权限修饰符为 private，类型为 int，名称为 age。</p><p>字段的访问标志和类的访问标志非常类似。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/bytecode-5f328e11-3486-4eb4-8fa9-5c5febfab894.png" alt="" loading="lazy"></p><h3 id="_05、方法表集合" tabindex="-1"><a class="header-anchor" href="#_05、方法表集合" aria-hidden="true">#</a> <strong>05、方法表集合</strong></h3><p>方法表用来描述接口或者类中声明的方法，包括类方法和成员方法，以及构造方法。方法的修饰符和字段略有不同，比如说 volatile 和 transient 不能用来修饰方法，再比如说方法的修饰符多了 synchronized、native、strictfp 和 abstract。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/bytecode-fd434d5c-ffc6-4a24-9787-98e573035068.png" alt="" loading="lazy"></p><p>下面这部分为构造方法，返回类型为 void，访问标志为 public。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  public com.itwanger.jvm.Main();
    descriptor: ()V
    flags: (0x0001) ACC_PUBLIC
