import{_ as i,W as r,X as l,Y as e,a0 as n,Z as t,a1 as s,C as d}from"./framework-bb7be5cb.js";const o={},c=e("p",null,"TreeMap，虽然也是个 Map，但存在感太低了。我做程序员这十多年里，HashMap 用了超过十年，TreeMap 只用了多字里那么一小会儿一小会儿，真的是，太惨了。",-1),p=e("p",null,"虽然 TreeMap 用得少，但还是有用处的。",-1),u={href:"https://tobebetterjavaer.com/collection/linkedhashmap.html",target:"_blank",rel:"noopener noreferrer"},v=s(`<p>TreeMap 由红黑树实现，可以保持元素的自然顺序，或者实现了 Comparator 接口的自定义顺序。</p><p>可能有些同学不知道红黑树，理解起来 TreeMap 就有点难度，那我先来普及一下：</p><blockquote><p>红黑树（英语：Red–black tree）是一种自平衡的二叉查找树（Binary Search Tree），结构复杂，但却有着良好的性能，完成查找、插入和删除的时间复杂度均为 log(n)。</p></blockquote><p>二叉查找树又是什么呢？</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-c5f29a61-91e0-47e8-9e16-055e1bea5b33.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>上图中这棵树，就是一颗典型的二叉查找树：</p><p>1）左子树上所有节点的值均小于或等于它的根结点的值。</p><p>2）右子树上所有节点的值均大于或等于它的根结点的值。</p><p>3）左、右子树也分别为二叉查找树。</p><p>理解二叉查找树了吧？不过，二叉查找树有一个不足，就是容易变成瘸子，就是一侧多，一侧少，就像下图这样：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-6c3309a0-3737-4677-99c1-e8a156140d62.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>查找的效率就要从 log(n) 变成 o(n) 了，对吧？必须要平衡一下，对吧？于是就有了平衡二叉树，左右两个子树的高度差的绝对值不超过 1，就像下图这样：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-b8f74a3d-baf9-4192-a0e0-cdd07955d784.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>红黑树，顾名思义，就是节点是红色或者黑色的平衡二叉树，它通过颜色的约束来维持着二叉树的平衡：</p><p>1）每个节点都只能是红色或者黑色</p><p>2）根节点是黑色</p><p>3）每个叶节点（NIL 节点，空节点）是黑色的。</p><p>4）如果一个节点是红色的，则它两个子节点都是黑色的。也就是说在一条路径上不能出现相邻的两个红色节点。</p><p>5）从任一节点到其每个叶子的所有路径都包含相同数目的黑色节点。</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-3373c98c-d82f-4a7f-949e-a7fe0d99314c.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>那，关于红黑树，同学们就先了解到这，脑子里有个大概的印象，知道 TreeMap 是个什么玩意。</p><h2 id="_01、自然顺序" tabindex="-1"><a class="header-anchor" href="#_01、自然顺序" aria-hidden="true">#</a> 01、自然顺序</h2><p>默认情况下，TreeMap 是根据 key 的自然顺序排列的。比如说整数，就是升序，1、2、3、4、5。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>TreeMap&lt;Integer,String&gt; mapInt = new TreeMap&lt;&gt;();
mapInt.put(3, &quot;沉默王二&quot;);
mapInt.put(2, &quot;沉默王二&quot;);
mapInt.put(1, &quot;沉默王二&quot;);
mapInt.put(5, &quot;沉默王二&quot;);
...
[1, 2]
[3, 4, 5]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_04、如何选择-map" tabindex="-1"><a class="header-anchor" href="#_04、如何选择-map" aria-hidden="true">#</a> 04、如何选择 Map</h2>`,54),m={href:"https://tobebetterjavaer.com/collection/hashmap.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://tobebetterjavaer.com/collection/linkedhashmap.html",target:"_blank",rel:"noopener noreferrer"},g=e("p",null,"HashMap、LinkedHashMap、TreeMap 都实现了 Map 接口，并提供了几乎相同的功能（增删改查）。它们之间最大的区别就在于元素的顺序：",-1),h=e("p",null,"HashMap 完全不保证元素的顺序，添加了新的元素，之前的顺序可能完全逆转。",-1),x=e("p",null,"LinkedHashMap 默认会保持元素的插入顺序。",-1),_=e("p",null,[n("TreeMap 默认会保持 key 的自然顺序（根据 "),e("code",null,"compareTo()"),n(" 方法）。")],-1),f=e("p",null,"来个表格吧，一目了然。",-1),y=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/collection/treemap-f94219fb-b6ef-4192-8174-4759498f857f.jpg",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),T=e("hr",null,null,-1),q=e("strong",null,"数据库、计算机网络、算法与数据结构、设计模式、框架类Spring、Netty、微服务（Dubbo，消息队列） 网关",-1),M={href:"https://tobebetterjavaer.com/pdf/programmer-111.html",target:"_blank",rel:"noopener noreferrer"},k=e("p",null,[n("微信搜 "),e("strong",null,"沉默王二"),n(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"111"),n(" 即可免费领取。")],-1),S=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function I(j,K){const a=d("ExternalLinkIcon");return r(),l("div",null,[c,p,e("p",null,[n("之前 "),e("a",u,[n("LinkedHashMap"),t(a)]),n(" 那篇文章里提到过了，HashMap 是无序的，所有有了 LinkedHashMap，加上了双向链表后，就可以保持元素的插入顺序和访问顺序，那 TreeMap 呢？")]),v,e("p",null,[n("在学习 TreeMap 之前，我们已经学习了 "),e("a",m,[n("HashMap"),t(a)]),n(" 和 "),e("a",b,[n("LinkedHashMap"),t(a)]),n(" ，那如何从它们三个中间选择呢？")]),g,h,x,_,f,y,T,e("p",null,[n("最近整理了一份牛逼的学习资料，包括但不限于Java基础部分（JVM、Java集合框架、多线程），还囊括了 "),q,n(" 等等等等……详情戳："),e("a",M,[n("可以说是2022年全网最全的学习和找工作的PDF资源了"),t(a)])]),k,S])}const H=i(o,[["render",I],["__file","treemap.html.vue"]]);export{H as default};
