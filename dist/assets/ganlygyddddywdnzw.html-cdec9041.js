...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基础服务层不仅仅包括资源库，与第三方的调用，都需要放到该层，Demo 中没有该示例，我们可以看一个小米内部具体的实际项目，他把第三方的调用放到了 remote 目录中：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-ganlygyddddywdnzw-b2c62061-fb0f-414d-8b93-c804e90b9668.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_4-5-领域层" tabindex="-1"><a class="header-anchor" href="#_4-5-领域层" aria-hidden="true">#</a> 4.5 领域层</h3><h5 id="_4-5-1-聚合-聚合根" tabindex="-1"><a class="header-anchor" href="#_4-5-1-聚合-聚合根" aria-hidden="true">#</a> 4.5.1 聚合&amp;聚合根</h5><p>我们有用户和角色两个实体，可以将用户、角色和两者关系进行聚合，然后用户就是聚合根，聚合之后的属性，我们称之为“权限”。</p><p>对于地址 Address，目前是作为字段属性存储到 DB 中，如果对地址无需进行检索，可以把地址作为“值对象”进行存储，即把地址序列化为 Json 存，存储到 DB 的一个字段中。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class AuthorizeDO {
    // 用户ID
    private Long userId;
    // 用户名
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们其实可以把领域服务再进一步抽象，可以抽象出领域能力，通过这些领域能力去构建应用层逻辑，比如账号相关的领域能力可以包括授权领域能力、身份认证领域能力等，这样每个领域能力相对独立，就不会全部揉到一个文件中，下面是实际项目的领域层截图：</p><figure><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-ganlygyddddywdnzw-9a6e50c2-61a5-4a87-8fbd-5e0fc962ac67.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h5 id="_4-5-3-领域事件" tabindex="-1"><a class="header-anchor" href="#_4-5-3-领域事件" aria-hidden="true">#</a> 4.5.3 领域事件</h5><p>领域事件 = 事件发布 + 事件存储 + 事件分发 + 事件处理。</p><p>这个 Demo 中，对领域事件的处理非常简单，还是一个应用内部的领域事件，就是每次执行一次具体的操作时，把行为记录下来。Demo 中没有记录事件的库表，事件的分发还是同步的方式，所以 Demo 中的领域事件还不完善，后面我会再继续完善 Demo 中的领域事件，通过 Java 消息机制实现解耦，甚至可以借助消息队列，实现异步。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/**
 * 领域事件基类
 *
 * @author louzai
 * @since 2021/11/22
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_5-结语" tabindex="-1"><a class="header-anchor" href="#_5-结语" aria-hidden="true">#</a> 5. 结语</h2><p>最后，谈谈二哥对 DDD 的理解，我觉得 DDD 不像一门技术，我理解的技术比如高并发、缓存、消息队列等，<strong>DDD 更像是一项软技能，一种方法论，包含了很多设计理念。</strong></p><p>大家不要认为，掌握了一些概念，以及 DDD 的基本思想，就掌握了 DDD，然后做项目时，照葫芦画瓢，这样你会死的很惨！</p><p>只掌握 DDD 表面的东西，其实是不够的，<strong>我觉得 DDD 最复杂的地方，其实是在它的领域设计部分</strong>，项目启动前，你一定要设计各个领域对象，以及它们直接的交互关系。</p><p>比如我们之前做过一个项目，因为这块没有做好，大家一边写代码，一边还在思考，这个领域对象该如何构造，严重影响开发效率，<strong>最后又不得不回退到 MVC 的模式。</strong></p><p>不要为了炫技，啥都要搞个 DDD，两者如何选择：</p><ul><li><strong>MVC</strong>：上来就可以开干，短平快，<strong>前期用起来很香，整体开发效率也更高</strong>，所以对于紧急，或者不那么重要的项目，我会直接用 MVC 怼，不好的地方就是，后面会越来越复杂，可能最后就是一坨屎山，<strong>但是很多时候，比如老板进度催的紧，我哪想到那么多以后呢？</strong></li><li><strong>DDD</strong>：前期需要花大量时间设计好领域模型，<strong>对于一些基础组件，或者一些核心服务，如果对象模型非常复杂，建议采用 DDD</strong>，前期可能会稍微痛苦一些，但是后期维护起来会非常方便。</li></ul><hr><p><em>没有什么使我停留——除了目的，纵然岸旁有玫瑰、有绿荫、有宁静的港湾，我是不系之舟</em>。</p><p><strong>推荐阅读</strong>：</p>`,15),y={href:"https://mp.weixin.qq.com/s/XWwqzrHAJ0vtY3lNilqVkg",target:"_blank",rel:"noopener noreferrer"},z={href:"https://mp.weixin.qq.com/s/gb48ZAqDCwXInUWM7q0EaQ",target:"_blank",rel:"noopener noreferrer"},R={href:"https://mp.weixin.qq.com/s/-LNhq_OBHDBZzAEMurqBJw",target:"_blank",rel:"noopener noreferrer"},w={href:"https://mp.weixin.qq.com/s/PZcWj0NbWRGdS0I9ACMqbg",target:"_blank",rel:"noopener noreferrer"},A=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/nice-article/weixin-ganlygyddddywdnzw-a487294e-13a8-402c-afc6-e63baffa671b.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1),U=e("hr",null,null,-1),T={href:"https://github.com/itwanger/toBeBetterJavaer",target:"_blank",rel:"noopener noreferrer"},E={href:"https://javabetter.cn/overview/",target:"_blank",rel:"noopener noreferrer"},q=e("p",null,[i("微信搜 "),e("strong",null,"沉默王二"),i(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),e("strong",null,"222"),i(" 即可免费领取。")],-1),C=e("figure",null,[e("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function I(P,S){const n=r("ExternalLinkIcon");return s(),t("div",null,[e("blockquote",null,[e("p",null,[e("a",c,[i("二哥编程知识星球"),a(n)]),i(" （戳链接加入）正式上线了，来和 "),u,i(" 小伙伴一起打怪升级吧！这是一个 Java 学习指南 + 编程实战的私密圈子，你可以向二哥提问、帮你制定学习计划、跟着二哥一起做实战项目，冲冲冲。"),o,m,b,i(" 二哥的Java进阶之路网址："),e("a",p,[i("https://javabetter.cn"),a(n)])])]),h,e("ul",null,[g,D,f,_,e("li",null,[e("p",null,[i("请求 URL："),e("a",x,[i("http://127.0.0.1:8087/api/user/save"),a(n)])])]),O]),j,e("ul",null,[e("li",null,[e("a",y,[i("我扔进垃圾桶的第一本 Java 书..."),a(n)])]),e("li",null,[e("a",z,[i("一键部署 Spring Boot 项目"),a(n)])]),e("li",null,[e("a",R,[i("离开北京？"),a(n)])]),e("li",null,[e("a",w,[i("编程喵实战项目可以在本地跑起来辣！"),a(n)])])]),A,U,e("p",null,[i("GitHub 上标星 8700+ 的开源知识库《"),e("a",T,[i("二哥的 Java 进阶之路"),a(n)]),i("》第一版 PDF 终于来了！包括Java基础语法、数组&字符串、OOP、集合框架、Java IO、异常处理、Java 新特性、网络编程、NIO、并发编程、JVM等等，共计 32 万余字，可以说是通俗易懂、风趣幽默……详情戳："),e("a",E,[i("太赞了，GitHub 上标星 8700+ 的 Java 教程"),a(n)])]),q,C])}const V=l(v,[["render",I],["__file","ganlygyddddywdnzw.html.vue"]]);export{V as default};
